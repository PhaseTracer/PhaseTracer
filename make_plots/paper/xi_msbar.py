...
if __name__ == "__main__":
    ...
    lower = transpose_list_dict([call_pt("msbar", l, mtop, 0., tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
    central = transpose_list_dict([call_pt("msbar", l, mtop, 1., tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
    upper = transpose_list_dict([call_pt("msbar", l, mtop, 2., tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
