...
if __name__ == "__main__":
    ...
    lower = transpose_list_dict([call_pt("covariant_gauge", l, 0.5 * mtop, xi, tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
    central = transpose_list_dict([call_pt("covariant_gauge", l, mtop, xi, tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
    upper = transpose_list_dict([call_pt("covariant_gauge", l, 2. * mtop, xi, tree_level_tadpoles, tree_ewsb) for l in lambda_hs])
    ...
    plt.tight_layout()
    plt.savefig("scale_covariant_gauge.pdf")
