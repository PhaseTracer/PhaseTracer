...
/**
 * @file THDMIISNMSSMBCsimple_l_to_lgamma.cpp
 *
...
using namespace THDMIISNMSSMBCsimple_FFV_form_factors;
...
double lepton_total_decay_width(
      ...
      const THDMIISNMSSMBCsimple_mass_eigenstates& model, const softsusy::QedQcd& qedqcd) {
