...
#ifndef THDMIISNMSSMBCsimple_PHYSICAL_H
#define THDMIISNMSSMBCsimple_PHYSICAL_H
...
struct THDMIISNMSSMBCsimple_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const THDMIISNMSSMBCsimple_physical&);
