...
#ifndef THDMIISNMSSMBCsimple_WEINBERG_ANGLE_H
#define THDMIISNMSSMBCsimple_WEINBERG_ANGLE_H
...
/**
 * @class THDMIISNMSSMBCsimple_weinberg_angle
...
public:
   ...
   THDMIISNMSSMBCsimple_weinberg_angle(const THDMIISNMSSMBCsimple_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const THDMIISNMSSMBCsimple_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const THDMIISNMSSMBCsimple_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
