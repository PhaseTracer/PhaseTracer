Get["models/THDMIISNMSSMBCsimple/THDMIISNMSSMBCsimple_librarylink.m"];

handle = FSTHDMIISNMSSMBCsimpleOpenHandle[
    fsSettings -> {
...
spectrum    = FSTHDMIISNMSSMBCsimpleCalculateSpectrum[handle];
observables = FSTHDMIISNMSSMBCsimpleCalculateObservables[handle];
FSTHDMIISNMSSMBCsimpleCloseHandle[handle];
