...
int main(int argc, char* argv[]) {
  ...
  // default output
  std::string output_filename = "comparisonData/nucleationType/scan/ht.csv";
  ...
  try {
    ...
    std::string output_file_path = "comparisonData/nucleationType/ht/thermal_profiles/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + ".csv";
  ...
  const std::string path_fit = "example/TestDeepPhase/helperIncludes/ht_vw_fit_params.json";
  ...
  std::string eos_path = "comparisonData/nucleationType/ht/eos/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + ".csv";
  ...
  if(vw > 0)
  {
    try {
      ...
      std::string def_bag_path = "comparisonData/nucleationType/ht/fluid_profiles/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_bag.csv";
      ...
      std::string def_bag_spectrum_path = "comparisonData/nucleationType/ht/spectra/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_bag.csv";
    ...
    try {
      ...
      std::string def_munu_path = "comparisonData/nucleationType/ht/fluid_profiles/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_munu.csv";
      ...
      std::string def_munu_spectrum_path = "comparisonData/nucleationType/ht/spectra/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_munu.csv";
    ...
    try {
      ...
      std::string def_veff_path = "comparisonData/nucleationType/ht/fluid_profiles/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_veff.csv";
      ...
      std::string def_veff_spectrum_path = "comparisonData/nucleationType/ht/spectra/" + std::to_string(lambda_hs) + "_" + std::to_string(percolates) + "_" + std::to_string(nuc_type) + "_veff.csv";
