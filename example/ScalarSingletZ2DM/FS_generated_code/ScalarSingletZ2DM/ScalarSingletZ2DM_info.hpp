...
namespace ScalarSingletZ2DM_info {
   ...
   class ScalarSingletZ2DM_particle_names : public Names {
   public:
      virtual ~ScalarSingletZ2DM_particle_names() = default;
   ...
   class ScalarSingletZ2DM_parameter_names : public Names {
   public:
      virtual ~ScalarSingletZ2DM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletZ2DM_particle_names  particle_names_getter{};
   const ScalarSingletZ2DM_parameter_names parameter_names_getter{};
