...
#ifndef ScalarSingletZ2DM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define ScalarSingletZ2DM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "ScalarSingletZ2DM_low_scale_constraint.hpp"
...
template<>
class ScalarSingletZ2DM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ScalarSingletZ2DM_low_scale_constraint() = default;
   ScalarSingletZ2DM_low_scale_constraint(ScalarSingletZ2DM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~ScalarSingletZ2DM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "ScalarSingletZ2DM low-scale constraint"; }
