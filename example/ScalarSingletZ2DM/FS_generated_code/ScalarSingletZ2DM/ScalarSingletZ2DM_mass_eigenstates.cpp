...
/**
 * @file ScalarSingletZ2DM_mass_eigenstates.cpp
 * @brief implementation of the ScalarSingletZ2DM model class
 *
 * Contains the definition of the ScalarSingletZ2DM model class methods
...
#include "ScalarSingletZ2DM_ewsb_solver_interface.hpp"
#include "config.h"
...
#define CLASSNAME ScalarSingletZ2DM_mass_eigenstates
...
CLASSNAME::CLASSNAME(const ScalarSingletZ2DM_input_parameters& input_)
   : ScalarSingletZ2DM_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new ScalarSingletZ2DM_ewsb_solver<Two_scale>())
#endif
{
}
...
const ScalarSingletZ2DM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

ScalarSingletZ2DM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const ScalarSingletZ2DM_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving ScalarSingletZ2DM EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "ScalarSingletZ2DM\n"
           "========================================\n";
   ScalarSingletZ2DM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_pole_tachyon(ScalarSingletZ2DM_info::ss);
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(ScalarSingletZ2DM_info::hh);
...
{
   ScalarSingletZ2DM_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   ScalarSingletZ2DM_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DM_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DM_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DM_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DM_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DM_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DM_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DM_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DM_info::VWp);
   }
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VG);
}

void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletZ2DM_info::ss)
      )
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::ss);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::ss);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fv);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletZ2DM_info::hh)
      )
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::hh);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletZ2DM_info::VZ)
      )
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(ScalarSingletZ2DM_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VZ);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::Fe);
}

void CLASSNAME::calculate_MVWp_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletZ2DM_info::VWp
      ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(ScalarSingletZ2DM_info::VWp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VWp);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DM_info::VWp);
}
