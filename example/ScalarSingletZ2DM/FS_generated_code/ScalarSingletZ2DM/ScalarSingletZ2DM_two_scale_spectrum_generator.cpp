...
double ScalarSingletZ2DM_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
                                ...
                                const ScalarSingletZ2DM_input_parameters& input)
{
   ...
   ScalarSingletZ2DM_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   high_scale_constraint.initialize();
   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   ScalarSingletZ2DM_convergence_tester<Two_scale> convergence_tester(
   ...
   ScalarSingletZ2DM_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
...
void ScalarSingletZ2DM_spectrum_generator<Two_scale>::calculate_spectrum()
{
