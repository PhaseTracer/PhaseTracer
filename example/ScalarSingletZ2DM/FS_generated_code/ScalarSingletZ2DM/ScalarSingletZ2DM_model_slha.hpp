...
/**
 * @class ScalarSingletZ2DM_slha<T>
...
class ScalarSingletZ2DM_slha : public Model {
public:
   explicit ScalarSingletZ2DM_slha(const ScalarSingletZ2DM_input_parameters& input_ = ScalarSingletZ2DM_input_parameters());
   explicit ScalarSingletZ2DM_slha(const Model&, bool do_convert_masses_to_slha = true);
   ScalarSingletZ2DM_slha(const ScalarSingletZ2DM_slha&) = default;
   ScalarSingletZ2DM_slha(ScalarSingletZ2DM_slha&&) = default;
   virtual ~ScalarSingletZ2DM_slha() = default;
   ScalarSingletZ2DM_slha& operator=(const ScalarSingletZ2DM_slha&) = default;
   ScalarSingletZ2DM_slha& operator=(ScalarSingletZ2DM_slha&&) = default;
   ...
   const ScalarSingletZ2DM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   ScalarSingletZ2DM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   ScalarSingletZ2DM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
ScalarSingletZ2DM_slha<Model>::ScalarSingletZ2DM_slha(const ScalarSingletZ2DM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
ScalarSingletZ2DM_slha<Model>::ScalarSingletZ2DM_slha(const Model& model_,
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DM_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const ScalarSingletZ2DM_physical& ScalarSingletZ2DM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
ScalarSingletZ2DM_physical& ScalarSingletZ2DM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void ScalarSingletZ2DM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void ScalarSingletZ2DM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletZ2DM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
