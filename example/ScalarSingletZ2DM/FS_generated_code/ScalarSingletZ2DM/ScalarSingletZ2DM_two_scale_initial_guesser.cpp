...
ScalarSingletZ2DM_initial_guesser<Two_scale>::ScalarSingletZ2DM_initial_guesser(
   ScalarSingletZ2DM<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const ScalarSingletZ2DM_low_scale_constraint<Two_scale>& low_constraint_,
 ...
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void ScalarSingletZ2DM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void ScalarSingletZ2DM_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 * corrections).
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 */
void ScalarSingletZ2DM_initial_guesser<Two_scale>::guess_soft_parameters()
{
