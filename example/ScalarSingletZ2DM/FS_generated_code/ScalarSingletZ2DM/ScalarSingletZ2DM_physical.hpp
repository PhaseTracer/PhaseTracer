...
#ifndef ScalarSingletZ2DM_PHYSICAL_H
#define ScalarSingletZ2DM_PHYSICAL_H
...
struct ScalarSingletZ2DM_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DM_physical&);
