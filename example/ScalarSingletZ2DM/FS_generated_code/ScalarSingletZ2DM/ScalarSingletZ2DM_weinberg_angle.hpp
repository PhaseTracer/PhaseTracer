...
#ifndef ScalarSingletZ2DM_WEINBERG_ANGLE_H
#define ScalarSingletZ2DM_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletZ2DM_weinberg_angle
...
public:
   ...
   ScalarSingletZ2DM_weinberg_angle(const ScalarSingletZ2DM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletZ2DM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletZ2DM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
