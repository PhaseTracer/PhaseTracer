Get["models/ScalarSingletZ2DM/ScalarSingletZ2DM_librarylink.m"];

handle = FSScalarSingletZ2DMOpenHandle[
    fsSettings -> {
...
spectrum    = FSScalarSingletZ2DMCalculateSpectrum[handle];
observables = FSScalarSingletZ2DMCalculateObservables[handle];
FSScalarSingletZ2DMCloseHandle[handle];
