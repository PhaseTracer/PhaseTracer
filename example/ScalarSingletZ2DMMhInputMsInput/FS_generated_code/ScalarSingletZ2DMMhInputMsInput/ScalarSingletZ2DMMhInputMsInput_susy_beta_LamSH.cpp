 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamSH_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamSH_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamSH_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamSH_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamSH_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
