...
#ifndef ScalarSingletZ2DMMhInputMsInput_TWO_SCALE_INITIAL_GUESSER_H
#define ScalarSingletZ2DMMhInputMsInput_TWO_SCALE_INITIAL_GUESSER_H

#include "ScalarSingletZ2DMMhInputMsInput_initial_guesser.hpp"
...
/**
 * @class ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>
 * @brief initial guesser for the ScalarSingletZ2DMMhInputMsInput
 */

template<>
class ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ScalarSingletZ2DMMhInputMsInput_initial_guesser(ScalarSingletZ2DMMhInputMsInput<Two_scale>*,
                               const softsusy::QedQcd&,
                               const ScalarSingletZ2DMMhInputMsInput_low_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMMhInputMsInput_susy_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMMhInputMsInput_high_scale_constraint<Two_scale>&);
   virtual ~ScalarSingletZ2DMMhInputMsInput_initial_guesser() = default;
...
private:
   ScalarSingletZ2DMMhInputMsInput<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   ScalarSingletZ2DMMhInputMsInput_low_scale_constraint<Two_scale> low_constraint{};
   ScalarSingletZ2DMMhInputMsInput_susy_scale_constraint<Two_scale> susy_constraint{};
   ScalarSingletZ2DMMhInputMsInput_high_scale_constraint<Two_scale> high_constraint{};
