...
#ifndef ScalarSingletZ2DMMhInputMsInput_INFO_H
#define ScalarSingletZ2DMMhInputMsInput_INFO_H
...
namespace ScalarSingletZ2DMMhInputMsInput_info {
   ...
   enum Input_parameters : int { MhInput, LamSHInput, LamSInput, MsInput, QEWSB,
   ...
   public:
      virtual ~ScalarSingletZ2DMMhInputMsInput_particle_names() = default;
   ...
   class ScalarSingletZ2DMMhInputMsInput_parameter_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMMhInputMsInput_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletZ2DMMhInputMsInput_particle_names  particle_names_getter{};
   const ScalarSingletZ2DMMhInputMsInput_parameter_names parameter_names_getter{};
