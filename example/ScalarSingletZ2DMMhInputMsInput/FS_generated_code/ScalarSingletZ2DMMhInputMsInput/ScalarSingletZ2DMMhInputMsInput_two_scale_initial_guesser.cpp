...
ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::ScalarSingletZ2DMMhInputMsInput_initial_guesser(
   ScalarSingletZ2DMMhInputMsInput<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const ScalarSingletZ2DMMhInputMsInput_low_scale_constraint<Two_scale>& low_constraint_,
   const ScalarSingletZ2DMMhInputMsInput_susy_scale_constraint<Two_scale>& susy_constraint_,
   const ScalarSingletZ2DMMhInputMsInput_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("ScalarSingletZ2DMMhInputMsInput_initial_guesser: Error: pointer to model"
                       " ScalarSingletZ2DMMhInputMsInput<Two_scale> must not be zero");
}
 ...
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::guess()
{
 ...
 * \code{.cpp}
   ...
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
   MODEL->set_LamH(Re(Sqr(MhInput)/Sqr(LowEnergyConstant(vev))));
   MODEL->set_muS2(Re(Sqr(MsInput) - 0.5*LamSHInput*Sqr(LowEnergyConstant(vev))));

 * \endcode
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 * corrections).
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
   const auto v = MODELPARAMETER(v);
 ...
 */
void ScalarSingletZ2DMMhInputMsInput_initial_guesser<Two_scale>::guess_soft_parameters()
{
