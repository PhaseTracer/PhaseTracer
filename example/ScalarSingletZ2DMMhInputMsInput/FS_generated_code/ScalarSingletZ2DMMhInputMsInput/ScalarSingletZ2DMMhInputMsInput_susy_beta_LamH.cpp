 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamH_1_loop(const Susy_traces& susy_traces) const
{
   ...
   beta_LamH = Re(0.01*(1200*LamH*traceYdAdjYd - 1200*traceYdAdjYdYdAdjYd + 400
      *LamH*traceYeAdjYe - 400*traceYeAdjYeYeAdjYe + 1200*LamH*traceYuAdjYu -
      1200*traceYuAdjYuYuAdjYu + 27*Quad(g1) + 225*Quad(g2) - 180*LamH*Sqr(g1)
      - 900*LamH*Sqr(g2) + 90*Sqr(g1)*Sqr(g2) + 1200*Sqr(LamH) + 100*Sqr(LamSH)
      ));


   return oneLoop * beta_LamH;
}
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamH_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_LamH = Re(0.001*(-3000*LamH*traceYdAdjYdYdAdjYd + 60000*
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamH_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamH_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMMhInputMsInput_susy_parameters::calc_beta_LamH_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
