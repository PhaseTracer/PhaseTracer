...
/**
 * @file ScalarSingletZ2DMMhInputMsInput_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */


#ifndef ScalarSingletZ2DMMhInputMsInput_SLHA_H
#define ScalarSingletZ2DMMhInputMsInput_SLHA_H
...
/**
 * @class ScalarSingletZ2DMMhInputMsInput_slha<T>
 * @brief model class wrapper in SLHA convention
 *
 * @tparam Model model class to wrap
 */

class ScalarSingletZ2DMMhInputMsInput_slha : public ScalarSingletZ2DMMhInputMsInput_mass_eigenstates {
public:
   explicit ScalarSingletZ2DMMhInputMsInput_slha(const ScalarSingletZ2DMMhInputMsInput_input_parameters& input_ = ScalarSingletZ2DMMhInputMsInput_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit ScalarSingletZ2DMMhInputMsInput_slha(const ScalarSingletZ2DMMhInputMsInput_mass_eigenstates&, bool do_convert_masses_to_slha = true);
   ScalarSingletZ2DMMhInputMsInput_slha(const ScalarSingletZ2DMMhInputMsInput_slha&) = default;
   ScalarSingletZ2DMMhInputMsInput_slha(ScalarSingletZ2DMMhInputMsInput_slha&&) = default;
   virtual ~ScalarSingletZ2DMMhInputMsInput_slha() = default;
   ScalarSingletZ2DMMhInputMsInput_slha& operator=(const ScalarSingletZ2DMMhInputMsInput_slha&) = default;
   ScalarSingletZ2DMMhInputMsInput_slha& operator=(ScalarSingletZ2DMMhInputMsInput_slha&&) = default;
   ...
   const ScalarSingletZ2DMMhInputMsInput_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   ScalarSingletZ2DMMhInputMsInput_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   ScalarSingletZ2DMMhInputMsInput_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
