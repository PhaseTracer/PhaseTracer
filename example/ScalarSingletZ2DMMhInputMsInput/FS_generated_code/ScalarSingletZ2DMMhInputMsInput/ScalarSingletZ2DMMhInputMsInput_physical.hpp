...
#ifndef ScalarSingletZ2DMMhInputMsInput_PHYSICAL_H
#define ScalarSingletZ2DMMhInputMsInput_PHYSICAL_H
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInputMsInput_physical&);
