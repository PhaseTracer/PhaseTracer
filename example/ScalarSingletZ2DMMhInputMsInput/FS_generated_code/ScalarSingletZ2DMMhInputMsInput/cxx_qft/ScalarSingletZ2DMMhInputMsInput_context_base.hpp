...
/**
 * @file cxx_qft/ScalarSingletZ2DMMhInputMsInput_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.3 .
 */

#ifndef ScalarSingletZ2DMMhInputMsInput_CXXQFT_CONTEXT_BASE_H
#define ScalarSingletZ2DMMhInputMsInput_CXXQFT_CONTEXT_BASE_H

#include "ScalarSingletZ2DMMhInputMsInput_fields.hpp"
...
namespace ScalarSingletZ2DMMhInputMsInput_cxx_diagrams {
   ...
   struct context_base {
      ScalarSingletZ2DMMhInputMsInput_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(ScalarSingletZ2DMMhInputMsInput_mass_eigenstates_interface const& m) : model(m) {}
      context_base(ScalarSingletZ2DMMhInputMsInput_mass_eigenstates_interface const* const m) : model(*m) {}
