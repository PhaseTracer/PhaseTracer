...
public:
   ...
   virtual void fill_slha_io(ScalarSingletZ2DMMhInputMsInput_slha_io&, const Spectrum_generator_settings&) const = 0;
...
public:
   ...
   virtual void fill_slha_io(ScalarSingletZ2DMMhInputMsInput_slha_io&, const Spectrum_generator_settings&) const override;
