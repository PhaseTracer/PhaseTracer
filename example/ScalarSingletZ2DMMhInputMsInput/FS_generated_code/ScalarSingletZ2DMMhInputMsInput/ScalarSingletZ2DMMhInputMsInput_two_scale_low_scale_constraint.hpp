...
#ifndef ScalarSingletZ2DMMhInputMsInput_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define ScalarSingletZ2DMMhInputMsInput_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "ScalarSingletZ2DMMhInputMsInput_low_scale_constraint.hpp"
...
template<>
class ScalarSingletZ2DMMhInputMsInput_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ScalarSingletZ2DMMhInputMsInput_low_scale_constraint() = default;
   ScalarSingletZ2DMMhInputMsInput_low_scale_constraint(ScalarSingletZ2DMMhInputMsInput<Two_scale>*, const softsusy::QedQcd&);
   virtual ~ScalarSingletZ2DMMhInputMsInput_low_scale_constraint() = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "ScalarSingletZ2DMMhInputMsInput low-scale constraint"; }
