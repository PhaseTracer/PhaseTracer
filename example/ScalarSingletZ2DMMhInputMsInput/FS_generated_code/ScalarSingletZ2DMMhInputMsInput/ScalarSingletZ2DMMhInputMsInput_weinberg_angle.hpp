...
#ifndef ScalarSingletZ2DMMhInputMsInput_WEINBERG_ANGLE_H
#define ScalarSingletZ2DMMhInputMsInput_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletZ2DMMhInputMsInput_weinberg_angle
...
public:
   ...
   ScalarSingletZ2DMMhInputMsInput_weinberg_angle(const ScalarSingletZ2DMMhInputMsInput_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletZ2DMMhInputMsInput_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletZ2DMMhInputMsInput_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
