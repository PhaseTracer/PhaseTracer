...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_FFV_form_factors.cpp
 *
...
namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_FFV_form_factors {
std::valarray<std::complex<double>> calculate_Fe_Fe_VP_form_factors (
   int generationIndex1, int generationIndex2,
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model, bool discard_SM_contributions) {
