...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_l_to_lgamma.cpp
 *
...
using namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_FFV_form_factors;

namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_l_to_lgamma {
...
double lepton_total_decay_width(
      ...
      const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd) {
