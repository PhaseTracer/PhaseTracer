...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon.cpp
 *
 * This file was generated at Tue 17 Nov 2020 15:32:59 with FlexibleSUSY
 * 2.4.2 and SARAH 4.14.3 .
 */

#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates.hpp"

#include "cxx_qft/ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_qft.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_FFV_form_factors.hpp"
...
using namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_cxx_diagrams;
...
double get_MSUSY(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model)
{
   return 0.;
}

void run_to_MSUSY(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model)
{
   ...
   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: iterate to run to MSUSY ...");
   ...
   do {
      ...
      VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon:    running to new MSUSY = " << MSUSY_new);
   ...
   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: iteration finished. MSUSY = " << MSUSY_new);

   if (precision > precision_goal) {
      WARNING("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: run_to_MSUSY(): "
...
double calculate_a_muon_impl(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: calculating a_mu at Q = " << model.get_scale());

   context_base context{ model };
   
   using namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_cxx_diagrams::fields;

   const auto form_factors = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_FFV_form_factors::calculate_Fe_Fe_VP_form_factors(1, 1, model, true);
...
std::pair<double,double> vary_scale(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
   ...
   std::transform(scales.begin(), scales.end(), scales.begin(),
                  [&model,&qedqcd] (double scale) {
                     ...
                     try {
                        ...
                        ERROR("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: scale variation: " << e.what_detailed());
                     }
                     return amu;
                  });
...
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon::calculate_a_muon(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: starting calculation of a_mu ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon:" << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
...
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon::calculate_a_muon_uncertainty(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model_, const softsusy::QedQcd& qedqcd)
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates model(model_);

   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon: starting calculation of a_mu uncertainty ...");

   try {
      run_to_MSUSY(model);
      model.get_physical().clear();
   } catch (const Error& e) {
      ERROR("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_a_muon uncertainty: " << e.what_detailed());
      return std::numeric_limits<double>::quiet_NaN();
   }
