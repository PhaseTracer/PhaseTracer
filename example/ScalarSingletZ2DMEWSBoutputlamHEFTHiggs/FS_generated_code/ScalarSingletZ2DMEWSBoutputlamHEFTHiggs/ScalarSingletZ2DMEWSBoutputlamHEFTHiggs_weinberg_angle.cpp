...
#define CLASSNAME ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::normalization_g2;
