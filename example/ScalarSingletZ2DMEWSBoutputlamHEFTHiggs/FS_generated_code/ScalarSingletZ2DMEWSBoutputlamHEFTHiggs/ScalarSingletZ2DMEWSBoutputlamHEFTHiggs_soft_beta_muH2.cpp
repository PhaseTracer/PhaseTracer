 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::calc_beta_muH2_1_loop(const Soft_traces& soft_traces) const
{
   ...
   beta_muH2 = Re(0.1*oneOver16PiSqr*(60*LamH*muH2 + 10*LamSH*muS2 + 60*muH2*
      traceYdAdjYd + 20*muH2*traceYeAdjYe + 60*muH2*traceYuAdjYu - 9*muH2*Sqr(
      g1) - 45*muH2*Sqr(g2)));
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::calc_beta_muH2_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_muH2 = Re(0.0025*twoLoop*(-14400*LamH*muH2*traceYdAdjYd - 5400*muH2*
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::calc_beta_muH2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::calc_beta_muH2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::calc_beta_muH2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
