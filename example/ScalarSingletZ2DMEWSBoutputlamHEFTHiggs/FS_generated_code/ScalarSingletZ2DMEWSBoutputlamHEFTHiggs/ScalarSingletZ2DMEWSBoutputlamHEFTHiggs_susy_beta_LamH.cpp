 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_parameters::calc_beta_LamH_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_parameters::calc_beta_LamH_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_parameters::calc_beta_LamH_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_parameters::calc_beta_LamH_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_parameters::calc_beta_LamH_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
