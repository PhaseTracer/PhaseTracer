...
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::clear()
{
   slha_io.clear();
}

void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_extpar(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_imminpar(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_imextpar(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_minpar(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_input(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::model_name)
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_mass(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& physical,
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_mixing_matrices(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& physical,
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_ckm(
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_pmns(
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::get_parameter_output_scale() const
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input) const
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_drbar_parameters(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical physical_hk;
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_minpar_tuple(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input,
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_extpar_tuple(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_imminpar_tuple(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_imextpar_tuple(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_physical(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& physical) const
{
   {
 ...
 */
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::read_scale() const
{
