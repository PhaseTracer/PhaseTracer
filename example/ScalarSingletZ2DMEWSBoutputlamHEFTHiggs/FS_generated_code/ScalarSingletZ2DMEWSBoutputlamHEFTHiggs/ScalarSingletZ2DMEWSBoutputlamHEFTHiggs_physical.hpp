...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_PHYSICAL_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_PHYSICAL_H
...
struct ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical&);
