...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_WEINBERG_ANGLE_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_weinberg_angle
...
public:
   ...
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_weinberg_angle(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
