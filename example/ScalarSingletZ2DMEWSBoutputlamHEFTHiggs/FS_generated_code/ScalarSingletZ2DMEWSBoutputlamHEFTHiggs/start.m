...
MakeFlexibleSUSY[InputFile -> FileNameJoin[{"models/ScalarSingletZ2DMEWSBoutputlamHEFTHiggs","FlexibleSUSY.m"}],
                 OutputDirectory -> "models/ScalarSingletZ2DMEWSBoutputlamHEFTHiggs",
                 DebugOutput -> False];
