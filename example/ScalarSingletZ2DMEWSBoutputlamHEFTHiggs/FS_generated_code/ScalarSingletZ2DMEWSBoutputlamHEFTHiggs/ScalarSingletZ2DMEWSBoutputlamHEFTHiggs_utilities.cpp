...
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_utilities.hpp"
...
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::extract_spectrum(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model)
{
   spectrum.clear();
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter::write_spectrum: "
...
namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_database {
 ...
 */
void to_database(
   const std::string& file_name, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& model,
   ...
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables* observables)
{
   ...
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_DRbar_mass_names());
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_pole_mass_names());
   append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_pole_mixing_names());
   ...
   if (ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables::get_names());
 ...
 */
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables* observables)
{
   using utilities::append;
   ...
   const auto number_of_masses = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter().get_number_of_masses();
   const auto number_of_mixings = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables::NUMBER_OF_OBSERVABLES : 0);
