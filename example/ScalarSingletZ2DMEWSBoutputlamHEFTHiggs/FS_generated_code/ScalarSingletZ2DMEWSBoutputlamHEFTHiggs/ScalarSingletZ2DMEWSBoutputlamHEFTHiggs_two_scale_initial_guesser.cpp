...
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser(
   ...
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_susy_scale_constraint<Two_scale>& susy_constraint_,
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_high_scale_constraint<Two_scale>& high_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_initial_guesser: Error: pointer to model"
                       " ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<Two_scale> must not be zero");
}
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
