...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_MASS_EIGENSTATES_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_MASS_EIGENSTATES_H
...
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver_interface;
/**
 * @class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates : public ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters {
public:
   explicit ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters());
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates&) = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates&&) = default;
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates() = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& operator=(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates&) = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates& operator=(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_physical(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& get_physical() const;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver_interface>&);
...
private:
   ...
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::model_name,
                     &ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::particle_names_getter,
                     &ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates&);
