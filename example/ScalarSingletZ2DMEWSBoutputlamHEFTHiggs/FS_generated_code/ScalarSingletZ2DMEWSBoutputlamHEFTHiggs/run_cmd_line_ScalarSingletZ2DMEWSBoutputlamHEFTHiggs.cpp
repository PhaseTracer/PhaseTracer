...
{
   std::cout <<
      "Usage: run_cmd_line_ScalarSingletZ2DMEWSBoutputlamHEFTHiggs.x [options]\n"
      "Options:\n"
      "  --muH2Input=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
int run_solver(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
