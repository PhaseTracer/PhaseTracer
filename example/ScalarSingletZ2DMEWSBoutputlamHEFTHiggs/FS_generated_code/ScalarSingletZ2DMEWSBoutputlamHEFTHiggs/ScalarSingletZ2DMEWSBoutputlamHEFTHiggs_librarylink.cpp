...
// File generated at Tue 17 Nov 2020 15:33:00
...
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_model_slha.hpp"

#ifdef ENABLE_TWO_SCALE_SOLVER
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_two_scale_model.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_two_scale_spectrum_generator.hpp"
#endif
...
namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink {
...
private:
   ...
   void flush() {
      ...
      while (std::getline(buffer, line)) {
         ...
         MLPutFunction(link, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsMessage", 1);
...
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum {
public:
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum() = default;

   virtual void put_model_spectra(MLINK link) const = 0;

   virtual const Spectrum_generator_problems& get_problems() const = 0;
   virtual void fill_slha_io(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io&) const = 0;
   virtual double get_model_scale() const = 0;
   virtual const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables& get_observables() const = 0;

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters&) = 0;
   virtual void calculate_model_observables(const softsusy::QedQcd&, const Physical_input&) = 0;
};

template <typename Solver_type>
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl : public ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum
{
public:
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl() = default;
   ...
   virtual void fill_slha_io(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io&) const override;
   virtual double get_model_scale() const override { return std::get<0>(models).get_scale(); }
   virtual const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables& get_observables() const override { return observables; }

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters&) override;
   virtual void calculate_model_observables(const softsusy::QedQcd&, const Physical_input&) override;

private:
   std::tuple<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<Solver_type>>, standard_model::StandardModel<Two_scale>> models{};        ///< running parameters and pole masses
   Spectrum_generator_problems problems{};   ///< spectrum generator problems
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_scales scales{};              ///< scale information
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables observables{};    ///< observables
};
...
public:
   ...
   void set_input_parameters(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input_) { input = input_; }
...
private:
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters input{};     ///< model input parameters
   ...
   std::unique_ptr<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum> spectrum{nullptr};  ///< spectrum information

   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io get_slha_io() const;
...
void Model_data::check_spectrum_pointer() const
{
   if (!spectrum) {
      throw SetupError("No spectrum generator set! "
                       "Did you run FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum[]?");
   }
}
                ...
                const std::vector<std::string>& heads = {})
{
   for (std::size_t i = 0; i < flags.size(); i++) {
      if (flags[i]) {
         ...
         MLPutSymbol(link, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::particle_names[i].c_str());
      }
   }
}
...
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io Model_data::get_slha_io() const
{
   check_spectrum_pointer();
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io slha_io;
...
void put_spectrum(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>& model, MLINK link)
{
   MLPutRule(link, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::model_name);
...
template <typename Solver_type>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl<Solver_type>::put_model_spectra(MLINK link) const
{
...
template <typename Solver_type>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl<Solver_type>::calculate_spectrum(
   const Spectrum_generator_settings& settings,
   const SLHA_io::Modsel& modsel,
   const softsusy::QedQcd& qedqcd,
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input
)
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator<Solver_type> spectrum_generator;
...
template <typename Solver_type>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl<Solver_type>::calculate_model_observables(
...
template <typename Solver_type>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl<Solver_type>::fill_slha_io(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha_io& slha_io) const
{
...
{
   check_spectrum_pointer();
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_observables observables = spectrum->get_observables();
...
void Model_data::check_spectrum(MLINK link) const
{
   ...
   for (const auto& s: problems.get_problem_strings())
      put_message(link, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum", "error", s);

   for (const auto& s: problems.get_warning_strings())
      put_message(link, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum", "warning", s);
...
#ifdef ENABLE_TWO_SCALE_SOLVER
   case 1:
      spectrum.reset(new ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_impl<Two_scale>());
...
Model_data make_data(const Dynamic_array_view<Element_t>& pars)
{
   ...
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters input;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetSettings(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetSettings"))
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetSMInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetSMInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsOpenHandle(
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCloseHandle(
   WolframLibraryData /* libData */, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsSet(
   WolframLibraryData libData, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy;
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetProblems(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetProblems"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsToSLHA(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsToSLHA"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetWarnings(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsGetWarnings"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateObservables(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateObservables"))
      return LIBRARY_TYPE_ERROR;
   ...
   try {
      ...
      if (data.get_model_scale() == 0.) {
         put_message(link,
            "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateObservables", "warning",
            "Renormalization scale is 0.  Did you run "
            "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateSpectrum[]?");
      }
      ...
      put_message(link, "FSScalarSingletZ2DMEWSBoutputlamHEFTHiggsCalculateObservables", "error", e.what_detailed());
      put_error_output(link);
   }
