...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Tue 17 Nov 2020 15:32:56

#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_SLHA_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_SLHA_H
...
/**
 * @class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<T>
...
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha : public Model {
public:
   explicit ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters());
   explicit ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha&) = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha&&) = default;
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha() = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha& operator=(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha&) = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha& operator=(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha&&) = default;
   ...
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha(const Model& model_,
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
