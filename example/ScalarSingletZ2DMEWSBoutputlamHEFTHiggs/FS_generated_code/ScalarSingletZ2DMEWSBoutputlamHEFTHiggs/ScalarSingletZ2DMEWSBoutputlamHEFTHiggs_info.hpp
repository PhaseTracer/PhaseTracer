...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_INFO_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_INFO_H
...
namespace ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info {
   ...
   class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_particle_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_particle_names() = default;
   ...
   class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_particle_names  particle_names_getter{};
   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_names parameter_names_getter{};
