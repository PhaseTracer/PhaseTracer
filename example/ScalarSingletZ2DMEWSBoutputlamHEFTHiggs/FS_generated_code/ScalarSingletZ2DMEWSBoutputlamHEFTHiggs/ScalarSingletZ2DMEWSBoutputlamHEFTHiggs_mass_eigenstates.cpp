...
/**
 * @file ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Tue 17 Nov 2020 15:32:56 with FlexibleSUSY
...
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver_interface.hpp"
#include "config.h"
...
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates
...
CLASSNAME::CLASSNAME(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input_)
   : ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver<Two_scale
      >())
#endif
{
}
...
const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& CLASSNAME::get_physical() const
{
   return physical;
}

ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving ScalarSingletZ2DMEWSBoutputlamHEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           ...
           "========================================\n";
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_pole_tachyon(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::ss);
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::hh);
...
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
{
   return "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs";
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fd,
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fu,
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fe,
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::VWp);
   }
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::VG);
   else
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fv);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::VP);
}
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::VZ))
      return;
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::
            Fd, eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::
            Fu, eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::
            Fe, eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(
         ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::Fe);
}
...
double CLASSNAME::calculate_MVWp_pole(double p)
{
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_info::
         VWp);
