...
{
   std::cout <<
      "Usage: scan_ScalarSingletZ2DMEWSBoutputlamHEFTHiggs.x [options]\n"
      "Options:\n"
      "  --muH2Input=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
struct ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
   ...
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_scan_result result;
...
void scan(int solver_type, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input,
