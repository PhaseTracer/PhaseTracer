...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface {
public:
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface() = default;

   std::tuple<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>& get_model() const
   { return model; }
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>& get_model()
   { return model; }
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>> get_model_slha() const
   { return ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum.dat") const;

protected:
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T> model;
   ...
   void translate_exception_to_problem(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters&) = 0;
};
 ...
 */
template <class T>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters& input)
{
 ...
 */
template <class T>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates tmp_model(model);
   try {
   ...
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter parameter_getter;
   Coupling_monitor<ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_mass_eigenstates, ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_parameter_getter>
 ...
 */
template <class T>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator_interface<T>::translate_exception_to_problem(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<T>& model)
{
   try {
      throw;
