...
#ifndef ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_low_scale_constraint.hpp"
...
template<>
class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_low_scale_constraint() = default;
   ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_low_scale_constraint(ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs low-scale constraint"; }
