...
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator.hpp"
#include "ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_two_scale_spectrum_generator.hpp"


namespace fs = flexiblesusy;
typedef fs::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_spectrum_generator<fs::Two_scale> SpectrumGenerator;
typedef fs::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_slha<fs::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs<fs::Two_scale>> Model;
typedef fs::ScalarSingletZ2DMEWSBoutputlamHEFTHiggs_input_parameters Input;
typedef fs::Spectrum_generator_settings Settings;


namespace EffectivePotential {

class ScalarSingletZ2DMEWSBoutputlamHEFTHiggs : public OneLoopPotential {
 public:
  ScalarSingletZ2DMEWSBoutputlamHEFTHiggs() {
...
void ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::set_input(std::vector<double> x) {
  Input input;
  input.Qin = x[0];
  input.QEWSB = x[1];
  input.muH2Input = x[2];
...
double ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::V0(Eigen::VectorXd phi) const {
...
std::vector<double> ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::get_scalar_debye_sq(Eigen::VectorXd phi, double xi, double T) const {
...
std::vector<double> ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::get_vector_debye_sq(Eigen::VectorXd phi, double T) const {
...
std::vector<double> ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::get_scalar_masses_sq(Eigen::VectorXd phi, double xi) const {
  return get_scalar_debye_sq(phi, xi, 0.);
}

std::vector<double> ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::get_vector_masses_sq(Eigen::VectorXd phi) const {
  return get_vector_debye_sq(phi, 0.);
}

std::vector<double> ScalarSingletZ2DMEWSBoutputlamHEFTHiggs::get_fermion_masses_sq(Eigen::VectorXd phi) const {
  auto model_copy = model;
  model_copy.solve_ewsb_tree_level();
  model_copy.set_v(phi[0]);
