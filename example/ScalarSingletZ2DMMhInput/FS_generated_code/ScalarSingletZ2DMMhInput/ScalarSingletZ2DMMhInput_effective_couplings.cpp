...
#include "ScalarSingletZ2DMMhInput_effective_couplings.hpp"
...
ScalarSingletZ2DMMhInput_effective_couplings::ScalarSingletZ2DMMhInput_effective_couplings(
   const ScalarSingletZ2DMMhInput_mass_eigenstates& model_,
...
void ScalarSingletZ2DMMhInput_effective_couplings::calculate_effective_couplings()
{
...
void ScalarSingletZ2DMMhInput_effective_couplings::set_model(const ScalarSingletZ2DMMhInput_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void ScalarSingletZ2DMMhInput_effective_couplings::copy_mixing_matrices_from_model()
{
   Vd = PHYSICAL(Vd);
   Ud = PHYSICAL(Ud);
   Vu = PHYSICAL(Vu);
...
standard_model::Standard_model ScalarSingletZ2DMMhInput_effective_couplings::initialise_SM() const
{
...
void ScalarSingletZ2DMMhInput_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double ScalarSingletZ2DMMhInput_effective_couplings::number_of_active_flavours(double m) const
{
...
double ScalarSingletZ2DMMhInput_effective_couplings::scalar_scaling_factor(double m) const
{
...
double ScalarSingletZ2DMMhInput_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double ScalarSingletZ2DMMhInput_effective_couplings::get_hhVPVP_partial_width() const
{
   const double mass = PHYSICAL(Mhh);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP);
}

double ScalarSingletZ2DMMhInput_effective_couplings::get_hhVGVG_partial_width() const
{
   const double mass = PHYSICAL(Mhh);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG);
}

double ScalarSingletZ2DMMhInput_effective_couplings::get_AhVPVP_partial_width() const
{
   const double mass = PHYSICAL(MAh);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP);
}

double ScalarSingletZ2DMMhInput_effective_couplings::get_AhVGVG_partial_width() const
{
   const double mass = PHYSICAL(MAh);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG);
}

std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFdFdAhPL(int gI1, int gI2) const
{
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFeFeAhPL(int gI1, int gI2) const
{
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFuFuAhPL(int gI1, int gI2) const
{
...
double ScalarSingletZ2DMMhInput_effective_couplings::CphhconjVWpVWp() const
{
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFdFdhhPL(int gI1, int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFeFehhPL(int gI1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> ScalarSingletZ2DMMhInput_effective_couplings::CpbarFuFuhhPL(int gI1, int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
void ScalarSingletZ2DMMhInput_effective_couplings::calculate_eff_CphhVPVP()
{
...
void ScalarSingletZ2DMMhInput_effective_couplings::calculate_eff_CphhVGVG()
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
...
void ScalarSingletZ2DMMhInput_effective_couplings::calculate_eff_CpAhVPVP()
{
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
   const auto MFe = PHYSICAL(MFe);
...
void ScalarSingletZ2DMMhInput_effective_couplings::calculate_eff_CpAhVGVG()
{
   const auto g3 = MODELPARAMETER(g3);
   const auto MFd = PHYSICAL(MFd);
   const auto MFu = PHYSICAL(MFu);
