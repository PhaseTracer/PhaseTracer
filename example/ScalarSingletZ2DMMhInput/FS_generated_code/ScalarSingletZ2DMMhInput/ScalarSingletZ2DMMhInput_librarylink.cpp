...
namespace ScalarSingletZ2DMMhInput_librarylink {
...
private:
   ...
   void flush() {
      ...
      while (std::getline(buffer, line)) {
         ...
         MLPutFunction(link, "FSScalarSingletZ2DMMhInputMessage", 1);
...
class ScalarSingletZ2DMMhInput_spectrum {
public:
   virtual ~ScalarSingletZ2DMMhInput_spectrum() = default;

   virtual void put_model_spectra(MLINK link) const = 0;

   virtual const Spectrum_generator_problems& get_problems() const = 0;
   virtual void fill_slha_io(ScalarSingletZ2DMMhInput_slha_io&) const = 0;
   virtual double get_model_scale() const = 0;
   virtual const ScalarSingletZ2DMMhInput_observables& get_observables() const = 0;

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const ScalarSingletZ2DMMhInput_input_parameters&) = 0;
   virtual void calculate_model_observables(const softsusy::QedQcd&, const Physical_input&) = 0;
};

template <typename Solver_type>
class ScalarSingletZ2DMMhInput_spectrum_impl : public ScalarSingletZ2DMMhInput_spectrum
{
public:
   virtual ~ScalarSingletZ2DMMhInput_spectrum_impl() = default;
   ...
   virtual void fill_slha_io(ScalarSingletZ2DMMhInput_slha_io&) const override;
   virtual double get_model_scale() const override { return std::get<0>(models).get_scale(); }
   virtual const ScalarSingletZ2DMMhInput_observables& get_observables() const override { return observables; }

   virtual void calculate_spectrum(
      const Spectrum_generator_settings&, const SLHA_io::Modsel&,
      const softsusy::QedQcd&, const ScalarSingletZ2DMMhInput_input_parameters&) override;
   virtual void calculate_model_observables(const softsusy::QedQcd&, const Physical_input&) override;

private:
   std::tuple<ScalarSingletZ2DMMhInput<Solver_type>> models{};        ///< running parameters and pole masses
   Spectrum_generator_problems problems{};   ///< spectrum generator problems
   ScalarSingletZ2DMMhInput_scales scales{};              ///< scale information
   ScalarSingletZ2DMMhInput_observables observables{};    ///< observables
};
...
public:
   ...
   void set_input_parameters(const ScalarSingletZ2DMMhInput_input_parameters& input_) { input = input_; }
...
private:
   ScalarSingletZ2DMMhInput_input_parameters input{};     ///< model input parameters
   ...
   std::unique_ptr<ScalarSingletZ2DMMhInput_spectrum> spectrum{nullptr};  ///< spectrum information

   ScalarSingletZ2DMMhInput_slha_io get_slha_io() const;
...
void Model_data::check_spectrum_pointer() const
{
   if (!spectrum) {
      throw SetupError("No spectrum generator set! "
                       "Did you run FSScalarSingletZ2DMMhInputCalculateSpectrum[]?");
   }
}
                ...
                const std::vector<std::string>& heads = {})
{
   for (std::size_t i = 0; i < flags.size(); i++) {
      if (flags[i]) {
         ...
         MLPutSymbol(link, ScalarSingletZ2DMMhInput_info::particle_names[i].c_str());
      }
   }
}
...
ScalarSingletZ2DMMhInput_slha_io Model_data::get_slha_io() const
{
   check_spectrum_pointer();
   ScalarSingletZ2DMMhInput_slha_io slha_io;
...
void put_spectrum(const ScalarSingletZ2DMMhInput_slha& model, MLINK link)
{
   MLPutRule(link, ScalarSingletZ2DMMhInput_info::model_name);
...
template <typename Solver_type>
void ScalarSingletZ2DMMhInput_spectrum_impl<Solver_type>::put_model_spectra(MLINK link) const
{
...
template <typename Solver_type>
void ScalarSingletZ2DMMhInput_spectrum_impl<Solver_type>::calculate_spectrum(
   const Spectrum_generator_settings& settings,
   const SLHA_io::Modsel& modsel,
   const softsusy::QedQcd& qedqcd,
   const ScalarSingletZ2DMMhInput_input_parameters& input
)
{
   ScalarSingletZ2DMMhInput_spectrum_generator<Solver_type> spectrum_generator;
...
template <typename Solver_type>
void ScalarSingletZ2DMMhInput_spectrum_impl<Solver_type>::calculate_model_observables(
...
template <typename Solver_type>
void ScalarSingletZ2DMMhInput_spectrum_impl<Solver_type>::fill_slha_io(ScalarSingletZ2DMMhInput_slha_io& slha_io) const
{
...
{
   check_spectrum_pointer();
   ScalarSingletZ2DMMhInput_observables observables = spectrum->get_observables();
...
void Model_data::check_spectrum(MLINK link) const
{
   ...
   for (const auto& s: problems.get_problem_strings())
      put_message(link, "FSScalarSingletZ2DMMhInputCalculateSpectrum", "error", s);

   for (const auto& s: problems.get_warning_strings())
      put_message(link, "FSScalarSingletZ2DMMhInputCalculateSpectrum", "warning", s);
...
#ifdef ENABLE_TWO_SCALE_SOLVER
   case 1:
      spectrum.reset(new ScalarSingletZ2DMMhInput_spectrum_impl<Two_scale>());
...
Model_data make_data(const Dynamic_array_view<Element_t>& pars)
{
   ...
   ScalarSingletZ2DMMhInput_input_parameters input;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputGetSettings(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputGetSettings"))
...
DLLEXPORT int FSScalarSingletZ2DMMhInputGetSMInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputGetSMInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputGetInputParameters(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputGetInputParameters"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputOpenHandle(
...
DLLEXPORT int FSScalarSingletZ2DMMhInputCloseHandle(
   WolframLibraryData /* libData */, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputSet(
   WolframLibraryData libData, mint Argc, MArgument* Args, MArgument /* Res */)
{
   using namespace flexiblesusy;
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputGetProblems(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputGetProblems"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputToSLHA(WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputToSLHA"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputGetWarnings(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputGetWarnings"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputCalculateSpectrum(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputCalculateSpectrum"))
      return LIBRARY_TYPE_ERROR;
...
DLLEXPORT int FSScalarSingletZ2DMMhInputCalculateObservables(
   WolframLibraryData /* libData */, MLINK link)
{
   using namespace flexiblesusy::ScalarSingletZ2DMMhInput_librarylink;

   if (!check_number_of_args(link, 1, "FSScalarSingletZ2DMMhInputCalculateObservables"))
      return LIBRARY_TYPE_ERROR;
   ...
   try {
      ...
      if (data.get_model_scale() == 0.) {
         put_message(link,
            "FSScalarSingletZ2DMMhInputCalculateObservables", "warning",
            "Renormalization scale is 0.  Did you run "
            "FSScalarSingletZ2DMMhInputCalculateSpectrum[]?");
      }
      ...
      put_message(link, "FSScalarSingletZ2DMMhInputCalculateObservables", "error", e.what_detailed());
      put_error_output(link);
   }
