...
#ifndef ScalarSingletZ2DMMhInput_PHYSICAL_H
#define ScalarSingletZ2DMMhInput_PHYSICAL_H
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInput_physical&);
