...
#ifndef ScalarSingletZ2DMMhInput_INFO_H
#define ScalarSingletZ2DMMhInput_INFO_H
...
namespace ScalarSingletZ2DMMhInput_info {
   ...
   enum Input_parameters : int { MhInput, LamSHInput, LamSInput, muS2Input, QEWSB,
      Qin, NUMBER_OF_INPUT_PARAMETERS };
   ...
   class ScalarSingletZ2DMMhInput_particle_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMMhInput_particle_names() = default;
   ...
   class ScalarSingletZ2DMMhInput_parameter_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMMhInput_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletZ2DMMhInput_particle_names  particle_names_getter{};
   const ScalarSingletZ2DMMhInput_parameter_names parameter_names_getter{};
