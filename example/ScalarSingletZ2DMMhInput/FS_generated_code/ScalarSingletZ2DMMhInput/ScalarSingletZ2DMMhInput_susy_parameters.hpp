...
#ifndef ScalarSingletZ2DMMhInput_susy_parameters_H
#define ScalarSingletZ2DMMhInput_susy_parameters_H
...
class ScalarSingletZ2DMMhInput_susy_parameters : public Beta_function {
public:
   explicit ScalarSingletZ2DMMhInput_susy_parameters(const ScalarSingletZ2DMMhInput_input_parameters& input_ = ScalarSingletZ2DMMhInput_input_parameters());
   ScalarSingletZ2DMMhInput_susy_parameters(double scale_, int loops_, int thresholds_, const ScalarSingletZ2DMMhInput_input_parameters& input_, double g1_, double g2_, double g3_, double LamS_, double LamSH_, double LamH_
   , const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix<double,3,3>& Yd_
   , const Eigen::Matrix<double,3,3>& Ye_);
   ScalarSingletZ2DMMhInput_susy_parameters(const ScalarSingletZ2DMMhInput_susy_parameters&) = default;
   ScalarSingletZ2DMMhInput_susy_parameters(ScalarSingletZ2DMMhInput_susy_parameters&&) = default;
   virtual ~ScalarSingletZ2DMMhInput_susy_parameters() = default;
   ScalarSingletZ2DMMhInput_susy_parameters& operator=(const ScalarSingletZ2DMMhInput_susy_parameters&) = default;
   ScalarSingletZ2DMMhInput_susy_parameters& operator=(ScalarSingletZ2DMMhInput_susy_parameters&&) = default;
   ...
   const ScalarSingletZ2DMMhInput_input_parameters& get_input() const;
   ScalarSingletZ2DMMhInput_input_parameters& get_input();
   void set_input_parameters(const ScalarSingletZ2DMMhInput_input_parameters&);

   ScalarSingletZ2DMMhInput_susy_parameters calc_beta() const;
   ScalarSingletZ2DMMhInput_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInput_susy_parameters&);
