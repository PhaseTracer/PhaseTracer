...
/**
 * @file ScalarSingletZ2DMMhInput_f_to_f_conversion.cpp
 *
...
namespace ScalarSingletZ2DMMhInput_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const ScalarSingletZ2DMMhInput_mass_eigenstates& model) {
