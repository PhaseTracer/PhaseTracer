...
#ifndef ScalarSingletZ2DMMhInput_TWO_SCALE_INITIAL_GUESSER_H
#define ScalarSingletZ2DMMhInput_TWO_SCALE_INITIAL_GUESSER_H

#include "ScalarSingletZ2DMMhInput_initial_guesser.hpp"
...
/**
 * @class ScalarSingletZ2DMMhInput_initial_guesser<Two_scale>
 * @brief initial guesser for the ScalarSingletZ2DMMhInput
 */

template<>
class ScalarSingletZ2DMMhInput_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ScalarSingletZ2DMMhInput_initial_guesser(ScalarSingletZ2DMMhInput<Two_scale>*,
                               const softsusy::QedQcd&,
                               const ScalarSingletZ2DMMhInput_low_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMMhInput_susy_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMMhInput_high_scale_constraint<Two_scale>&);
   virtual ~ScalarSingletZ2DMMhInput_initial_guesser() = default;
...
private:
   ScalarSingletZ2DMMhInput<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   ScalarSingletZ2DMMhInput_low_scale_constraint<Two_scale> low_constraint{};
   ScalarSingletZ2DMMhInput_susy_scale_constraint<Two_scale> susy_constraint{};
   ScalarSingletZ2DMMhInput_high_scale_constraint<Two_scale> high_constraint{};
