...
/**
 * @file ScalarSingletZ2DMMhInput_b_to_s_gamma.cpp
 *
...
using namespace ScalarSingletZ2DMMhInput_FFV_form_factors;

namespace ScalarSingletZ2DMMhInput_b_to_s_gamma {
   ...
   const double& matching_scale)
{
   ...
   wc_json.open ("WC_ScalarSingletZ2DMMhInput.json");
   wc_json << "{\n\"eft\": \"WET\",\n";
...
std::array<std::complex<double>, 4> calculate_b_to_s_gamma(
   const ScalarSingletZ2DMMhInput_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
