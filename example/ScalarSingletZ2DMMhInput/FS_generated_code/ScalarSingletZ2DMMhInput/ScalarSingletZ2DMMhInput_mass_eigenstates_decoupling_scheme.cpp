...
/**
 * @file ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme.cpp
 * @brief implementation of the ScalarSingletZ2DMMhInput model class in the decoupling scheme
 *
...
#include "ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme.hpp"
...
#define CLASSNAME ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme
...
CLASSNAME::CLASSNAME(const ScalarSingletZ2DMMhInput_mass_eigenstates& model)
{
   fill_from(model);
}
...
{
   return std::make_unique<ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme>(*this);
}
...
void CLASSNAME::fill_from(const ScalarSingletZ2DMMhInput_mass_eigenstates& model)
{
   set(model.get());
...
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme& model)
{
   model.print(ostr);
   return ostr;
}
