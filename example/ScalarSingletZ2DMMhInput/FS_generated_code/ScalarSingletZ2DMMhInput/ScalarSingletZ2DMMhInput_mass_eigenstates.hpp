...
/**
 * @file ScalarSingletZ2DMMhInput_mass_eigenstates.hpp
 *
...
#ifndef ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_H
#define ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_H
...
class ScalarSingletZ2DMMhInput_ewsb_solver_interface;
/**
 * @class ScalarSingletZ2DMMhInput_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class ScalarSingletZ2DMMhInput_mass_eigenstates
   : public ScalarSingletZ2DMMhInput_soft_parameters
   , public ScalarSingletZ2DMMhInput_mass_eigenstates_interface
{
public:
   explicit ScalarSingletZ2DMMhInput_mass_eigenstates(const ScalarSingletZ2DMMhInput_input_parameters& input_ = ScalarSingletZ2DMMhInput_input_parameters());
   ScalarSingletZ2DMMhInput_mass_eigenstates(const ScalarSingletZ2DMMhInput_mass_eigenstates&) = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates(ScalarSingletZ2DMMhInput_mass_eigenstates&&) = default;
   virtual ~ScalarSingletZ2DMMhInput_mass_eigenstates() = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates& operator=(const ScalarSingletZ2DMMhInput_mass_eigenstates&) = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates& operator=(ScalarSingletZ2DMMhInput_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMMhInput_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{ScalarSingletZ2DMMhInput_info::model_name,
   ...
   std::shared_ptr<ScalarSingletZ2DMMhInput_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInput_mass_eigenstates&);
