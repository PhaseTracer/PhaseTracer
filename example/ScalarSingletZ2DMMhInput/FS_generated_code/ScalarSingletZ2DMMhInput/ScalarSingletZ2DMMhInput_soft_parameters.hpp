...
#ifndef ScalarSingletZ2DMMhInput_soft_parameters_H
#define ScalarSingletZ2DMMhInput_soft_parameters_H
...
class ScalarSingletZ2DMMhInput_soft_parameters : public ScalarSingletZ2DMMhInput_susy_parameters {
public:
   explicit ScalarSingletZ2DMMhInput_soft_parameters(const ScalarSingletZ2DMMhInput_input_parameters& input_ = ScalarSingletZ2DMMhInput_input_parameters());
   ScalarSingletZ2DMMhInput_soft_parameters(const ScalarSingletZ2DMMhInput_susy_parameters& , double muS2_, double muH2_, double v_);
   ScalarSingletZ2DMMhInput_soft_parameters(const ScalarSingletZ2DMMhInput_soft_parameters&) = default;
   ScalarSingletZ2DMMhInput_soft_parameters(ScalarSingletZ2DMMhInput_soft_parameters&&) = default;
   virtual ~ScalarSingletZ2DMMhInput_soft_parameters() = default;
   ScalarSingletZ2DMMhInput_soft_parameters& operator=(const ScalarSingletZ2DMMhInput_soft_parameters&) = default;
   ScalarSingletZ2DMMhInput_soft_parameters& operator=(ScalarSingletZ2DMMhInput_soft_parameters&&) = default;
   ...
   ScalarSingletZ2DMMhInput_soft_parameters calc_beta() const;
   ScalarSingletZ2DMMhInput_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInput_soft_parameters&);
