...
/**
 * @file ScalarSingletZ2DMMhInput_mass_eigenstates.cpp
...
#include "ScalarSingletZ2DMMhInput_ewsb_solver_interface.hpp"
#include "config.h"
...
#include "ScalarSingletZ2DMMhInput_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME ScalarSingletZ2DMMhInput_mass_eigenstates
...
CLASSNAME::CLASSNAME(const ScalarSingletZ2DMMhInput_input_parameters& input_)
   : ScalarSingletZ2DMMhInput_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new ScalarSingletZ2DMMhInput_ewsb_solver<Two_scale>())
#endif
{
}

std::unique_ptr<ScalarSingletZ2DMMhInput_mass_eigenstates_interface> CLASSNAME::clone() const
{
   return std::make_unique<ScalarSingletZ2DMMhInput_mass_eigenstates>(*this);
}
...
const ScalarSingletZ2DMMhInput_physical& CLASSNAME::get_physical() const
{
   return physical;
}

ScalarSingletZ2DMMhInput_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const ScalarSingletZ2DMMhInput_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMMhInput_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving ScalarSingletZ2DMMhInput EWSB at " << ewsb_loop_order << "-loop order");
...
{
   ostr << "========================================\n"
           "ScalarSingletZ2DMMhInput\n"
           "========================================\n";
   ScalarSingletZ2DMMhInput_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) { problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::ss); }
   if (PHYSICAL(Mhh) < 0.) { problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::hh); }
}
...
{
   ScalarSingletZ2DMMhInput_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
{
   return "ScalarSingletZ2DMMhInput";
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   ScalarSingletZ2DMMhInput_soft_parameters::run_to(scale, eps);
}
...
const ScalarSingletZ2DMMhInput_input_parameters& CLASSNAME::get_input_parameters() const
{
   return get_input();
}

ScalarSingletZ2DMMhInput_input_parameters& CLASSNAME::get_input_parameters()
{
   return get_input();
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DMMhInput_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DMMhInput_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DMMhInput_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DMMhInput_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(ScalarSingletZ2DMMhInput_info::VWp);
   }
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::VG)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         VG);
}
...
void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMMhInput_info::ss))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::ss)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         ss);
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::Fv)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         Fv);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMMhInput_info::hh))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::hh)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         hh);
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::VP)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         VP);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMMhInput_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::VZ);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::VZ)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         VZ);
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::Fd)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         Fd);
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::Fu)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         Fu);
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMMhInput_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::Fe)
         ;
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         Fe);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMMhInput_info::VWp))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::VWp);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::VWp
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMMhInput_info::
         VWp);
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::VZ);return
         m_pole;
   }
...
double CLASSNAME::calculate_MVWp_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(ScalarSingletZ2DMMhInput_info::VWp);return
         m_pole;
   }
