 ...
 */
double ScalarSingletZ2DMMhInput_susy_parameters::calc_beta_LamS_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_susy_parameters::calc_beta_LamS_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_susy_parameters::calc_beta_LamS_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_susy_parameters::calc_beta_LamS_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMMhInput_susy_parameters::calc_beta_LamS_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
