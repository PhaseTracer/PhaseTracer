...
ScalarSingletZ2DMMhInput_convergence_tester<Two_scale>::ScalarSingletZ2DMMhInput_convergence_tester(
   ScalarSingletZ2DMMhInput<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<ScalarSingletZ2DMMhInput<Two_scale> >(model, accuracy_goal, sg)
{
}

double ScalarSingletZ2DMMhInput_convergence_tester<Two_scale>::max_rel_diff() const
{
   const ScalarSingletZ2DMMhInput<Two_scale>& ol = get_last_iteration_model();
   const ScalarSingletZ2DMMhInput<Two_scale>& ne = get_current_iteration_model();
