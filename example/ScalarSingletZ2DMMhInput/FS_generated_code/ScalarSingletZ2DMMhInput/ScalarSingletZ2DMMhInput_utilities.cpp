...
#include "ScalarSingletZ2DMMhInput_utilities.hpp"
...
// ScalarSingletZ2DMMhInput_parameter_getter ////////////////////////////////////////

std::vector<std::string> ScalarSingletZ2DMMhInput_parameter_getter::get_mass_names(const std::string& head)
{
   using namespace ScalarSingletZ2DMMhInput_info;
...
std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_MIXINGS> ScalarSingletZ2DMMhInput_parameter_getter::get_mixing_names()
{
   return ScalarSingletZ2DMMhInput_info::particle_mixing_names;
}

Eigen::ArrayXd ScalarSingletZ2DMMhInput_parameter_getter::get_parameters(const ScalarSingletZ2DMMhInput_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_PARAMETERS> ScalarSingletZ2DMMhInput_parameter_getter::get_parameter_names()
{
   return ScalarSingletZ2DMMhInput_info::parameter_names;
}

std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_PARTICLES> ScalarSingletZ2DMMhInput_parameter_getter::get_particle_names()
{
   return ScalarSingletZ2DMMhInput_info::particle_names;
}

std::vector<std::string> ScalarSingletZ2DMMhInput_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> ScalarSingletZ2DMMhInput_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_MIXINGS> ScalarSingletZ2DMMhInput_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_MIXINGS> ScalarSingletZ2DMMhInput_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_INPUT_PARAMETERS> ScalarSingletZ2DMMhInput_parameter_getter::get_input_parameter_names()
{
   return ScalarSingletZ2DMMhInput_info::input_parameter_names;
}

std::array<std::string, ScalarSingletZ2DMMhInput_info::NUMBER_OF_EXTRA_PARAMETERS> ScalarSingletZ2DMMhInput_parameter_getter::get_extra_parameter_names()
{
   return ScalarSingletZ2DMMhInput_info::extra_parameter_names;
}

decltype(ScalarSingletZ2DMMhInput_info::NUMBER_OF_MASSES) ScalarSingletZ2DMMhInput_parameter_getter::get_number_of_masses()
{
   return ScalarSingletZ2DMMhInput_info::NUMBER_OF_MASSES;
}

// ScalarSingletZ2DMMhInput_spectrum_plotter ////////////////////////////////////////

ScalarSingletZ2DMMhInput_spectrum_plotter::ScalarSingletZ2DMMhInput_spectrum_plotter(const ScalarSingletZ2DMMhInput_mass_eigenstates& model)
{
   extract_spectrum(model);
}

void ScalarSingletZ2DMMhInput_spectrum_plotter::extract_spectrum(const ScalarSingletZ2DMMhInput_mass_eigenstates& model)
{
   spectrum.clear();
...
void ScalarSingletZ2DMMhInput_spectrum_plotter::write_to_file(const std::string& file_name) const
{
   if (spectrum.empty())
      return;

   std::ofstream filestr(file_name, std::ios::out);
   VERBOSE_MSG("ScalarSingletZ2DMMhInput_spectrum_plotter::write_to_file: opening file: "
               << file_name);
   if (filestr.fail()) {
      ERROR("ScalarSingletZ2DMMhInput_spectrum_plotter::write_to_file: can't open file "
            << file_name);
      return;
   }
   ...
   filestr.close();
   VERBOSE_MSG("ScalarSingletZ2DMMhInput_spectrum_plotter::write_to_file: file written: "
               << file_name);
}

void ScalarSingletZ2DMMhInput_spectrum_plotter::write_spectrum(const TSpectrum& spectrum, std::ofstream& filestr) const
{
   if (!filestr.good()) {
      ERROR("ScalarSingletZ2DMMhInput_spectrum_plotter::write_spectrum: "
...
namespace ScalarSingletZ2DMMhInput_database {
 ...
 */
void to_database(
   const std::string& file_name, const ScalarSingletZ2DMMhInput_mass_eigenstates& model,
   ...
   const ScalarSingletZ2DMMhInput_observables* observables)
{
   ...
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_input_parameter_names());
   append(values, model.get_input().get());

   // fill DR-bar parameters
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_parameter_names());
   append(values, model.get());

   // fill extra parameters
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_extra_parameter_names());
   append(values, model.get_extra_parameters());

   // fill DR-bar masses and mixings
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_DRbar_mass_names());
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_DRbar_mixing_names());
   append(values, model.get_DRbar_masses_and_mixings());

   // fill pole masses and mixings
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_pole_mass_names());
   append(names, ScalarSingletZ2DMMhInput_parameter_getter::get_pole_mixing_names());
   ...
   if (ScalarSingletZ2DMMhInput_observables::NUMBER_OF_OBSERVABLES > 0 && observables) {
      append(names, ScalarSingletZ2DMMhInput_observables::get_names());
 ...
 */
ScalarSingletZ2DMMhInput_mass_eigenstates from_database(
   const std::string& file_name, long long entry, softsusy::QedQcd* qedqcd,
   Physical_input* physical_input, ScalarSingletZ2DMMhInput_observables* observables)
{
   ScalarSingletZ2DMMhInput_mass_eigenstates model;
   const auto number_of_parameters = model.get_number_of_parameters();
   const auto number_of_masses = ScalarSingletZ2DMMhInput_parameter_getter::get_number_of_masses();
   const auto number_of_mixings = ScalarSingletZ2DMMhInput_info::NUMBER_OF_MIXINGS;
   const auto number_of_input_parameters = ScalarSingletZ2DMMhInput_info::NUMBER_OF_INPUT_PARAMETERS;
   const auto number_of_extra_parameters = ScalarSingletZ2DMMhInput_info::NUMBER_OF_EXTRA_PARAMETERS;
   ...
   const auto number_of_observables =
      (observables ? ScalarSingletZ2DMMhInput_observables::NUMBER_OF_OBSERVABLES : 0);
