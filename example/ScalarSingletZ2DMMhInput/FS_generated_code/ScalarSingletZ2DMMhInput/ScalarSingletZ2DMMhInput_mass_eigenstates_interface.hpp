...
/**
 * @file ScalarSingletZ2DMMhInput_mass_eigenstates_interface.hpp
 *
...
#ifndef ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_INTERFACE_H
#define ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class ScalarSingletZ2DMMhInput_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class ScalarSingletZ2DMMhInput_mass_eigenstates_interface {
public:
   virtual ~ScalarSingletZ2DMMhInput_mass_eigenstates_interface() {}

   virtual std::unique_ptr<ScalarSingletZ2DMMhInput_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const ScalarSingletZ2DMMhInput_input_parameters& get_input_parameters() const = 0;
   virtual ScalarSingletZ2DMMhInput_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const ScalarSingletZ2DMMhInput_physical& get_physical() const = 0;
   virtual ScalarSingletZ2DMMhInput_physical& get_physical() = 0;
   ...
   virtual void set_physical(const ScalarSingletZ2DMMhInput_physical&) = 0;
