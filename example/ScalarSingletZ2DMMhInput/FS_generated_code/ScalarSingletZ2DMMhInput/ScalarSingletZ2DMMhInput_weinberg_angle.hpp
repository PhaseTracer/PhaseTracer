...
#ifndef ScalarSingletZ2DMMhInput_WEINBERG_ANGLE_H
#define ScalarSingletZ2DMMhInput_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletZ2DMMhInput_weinberg_angle
...
public:
   ...
   ScalarSingletZ2DMMhInput_weinberg_angle(const ScalarSingletZ2DMMhInput_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletZ2DMMhInput_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletZ2DMMhInput_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
