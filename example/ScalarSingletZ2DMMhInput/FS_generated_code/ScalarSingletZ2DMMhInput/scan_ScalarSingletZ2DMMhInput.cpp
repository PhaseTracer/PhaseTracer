...
{
   std::cout <<
      "Usage: scan_ScalarSingletZ2DMMhInput.x [options]\n"
      "Options:\n"
      "  --MhInput=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
struct ScalarSingletZ2DMMhInput_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
ScalarSingletZ2DMMhInput_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   ScalarSingletZ2DMMhInput_input_parameters& input)
{
   ...
   ScalarSingletZ2DMMhInput_scan_result result;
...
void scan(int solver_type, int loop_library, ScalarSingletZ2DMMhInput_input_parameters& input,
