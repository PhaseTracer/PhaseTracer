...
#include "ScalarSingletZ2DMMhInput_observables.hpp"
...
ScalarSingletZ2DMMhInput_slha_io::ScalarSingletZ2DMMhInput_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void ScalarSingletZ2DMMhInput_slha_io::clear()
{
   slha_io.clear();
}

void ScalarSingletZ2DMMhInput_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 * SLHA output file.
 */
void ScalarSingletZ2DMMhInput_slha_io::fill(ScalarSingletZ2DMMhInput_slha& model) const
{
   fill(static_cast<ScalarSingletZ2DMMhInput_mass_eigenstates&>(model));
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_extpar(const ScalarSingletZ2DMMhInput_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMMhInput_slha_io::set_imminpar(const ScalarSingletZ2DMMhInput_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMMhInput_slha_io::set_imextpar(const ScalarSingletZ2DMMhInput_input_parameters& input)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMMhInput_slha_io::set_minpar(const ScalarSingletZ2DMMhInput_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletZ2DMMhInput_slha_io::set_input(const ScalarSingletZ2DMMhInput_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void ScalarSingletZ2DMMhInput_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, ScalarSingletZ2DMMhInput_info::model_name)
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_mass(const ScalarSingletZ2DMMhInput_physical& physical,
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_mixing_matrices(const ScalarSingletZ2DMMhInput_physical& physical,
...
void ScalarSingletZ2DMMhInput_slha_io::set_ckm(
...
void ScalarSingletZ2DMMhInput_slha_io::set_pmns(
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_model_parameters(const ScalarSingletZ2DMMhInput_slha& model)
{
   {
...
void ScalarSingletZ2DMMhInput_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
      std::ostringstream block;
...
void ScalarSingletZ2DMMhInput_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void ScalarSingletZ2DMMhInput_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void ScalarSingletZ2DMMhInput_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_spectrum(const ScalarSingletZ2DMMhInput_slha& model)
{
   const ScalarSingletZ2DMMhInput_physical physical(model.get_physical_slha());
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::set_extra(
   const ScalarSingletZ2DMMhInput_slha& model,
   const ScalarSingletZ2DMMhInput_scales& scales,
   const ScalarSingletZ2DMMhInput_observables& observables)
{
   const ScalarSingletZ2DMMhInput_physical physical(model.get_physical_slha());
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void ScalarSingletZ2DMMhInput_slha_io::write_to_file(const std::string& file_name) const
{
   slha_io.write_to_file(file_name);
}

void ScalarSingletZ2DMMhInput_slha_io::write_to_stream() const
{
   write_to_stream(std::cout);
}

void ScalarSingletZ2DMMhInput_slha_io::write_to_stream(std::ostream& ostr) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_slha_io::get_parameter_output_scale() const
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::fill(ScalarSingletZ2DMMhInput_input_parameters& input) const
{
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::fill_drbar_parameters(ScalarSingletZ2DMMhInput_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void ScalarSingletZ2DMMhInput_slha_io::fill(ScalarSingletZ2DMMhInput_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   ScalarSingletZ2DMMhInput_physical physical_hk;
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void ScalarSingletZ2DMMhInput_slha_io::fill_minpar_tuple(ScalarSingletZ2DMMhInput_input_parameters& input,
...
void ScalarSingletZ2DMMhInput_slha_io::fill_extpar_tuple(ScalarSingletZ2DMMhInput_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletZ2DMMhInput_slha_io::fill_imminpar_tuple(ScalarSingletZ2DMMhInput_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletZ2DMMhInput_slha_io::fill_imextpar_tuple(ScalarSingletZ2DMMhInput_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void ScalarSingletZ2DMMhInput_slha_io::fill_physical(ScalarSingletZ2DMMhInput_physical& physical) const
{
   {
 ...
 */
double ScalarSingletZ2DMMhInput_slha_io::read_scale() const
{
