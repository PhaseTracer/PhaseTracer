...
{
   std::cout <<
      "Usage: run_cmd_line_ScalarSingletZ2DMMhInput.x [options]\n"
      "Options:\n"
      "  --MhInput=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
int run_solver(int loop_library, const ScalarSingletZ2DMMhInput_input_parameters& input)
{
...
int run(int solver_type, int loop_library, const ScalarSingletZ2DMMhInput_input_parameters& input)
{
   int exit_code = 0;
