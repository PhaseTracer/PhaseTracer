...
#include "ScalarSingletZ2DMMhInput_two_scale_convergence_tester.hpp"
...
#include "ScalarSingletZ2DMMhInput_two_scale_initial_guesser.hpp"
...
double ScalarSingletZ2DMMhInput_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
 ...
 */
void ScalarSingletZ2DMMhInput_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const ScalarSingletZ2DMMhInput_input_parameters& input)
{
   ...
   ScalarSingletZ2DMMhInput_ewsb_solver<Two_scale> ewsb_solver;
   model.set_ewsb_solver(
      std::make_shared<ScalarSingletZ2DMMhInput_ewsb_solver<Two_scale> >(ewsb_solver));

   ScalarSingletZ2DMMhInput_high_scale_constraint<Two_scale> high_scale_constraint(&model);
   ScalarSingletZ2DMMhInput_susy_scale_constraint<Two_scale> susy_scale_constraint(&model, qedqcd);
   ScalarSingletZ2DMMhInput_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);
   ...
   ScalarSingletZ2DMMhInput_convergence_tester<Two_scale> convergence_tester(
   ...
   ScalarSingletZ2DMMhInput_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
 ...
 */
void ScalarSingletZ2DMMhInput_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   ScalarSingletZ2DMMhInput_spectrum_generator_interface<Two_scale>::write_running_couplings(
      filename, get_low_scale(), get_high_scale());
}

void ScalarSingletZ2DMMhInput_spectrum_generator<Two_scale>::calculate_spectrum()
{
