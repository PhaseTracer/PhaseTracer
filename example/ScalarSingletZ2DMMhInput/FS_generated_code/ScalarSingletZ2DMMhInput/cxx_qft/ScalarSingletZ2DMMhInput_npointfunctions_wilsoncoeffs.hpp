...
/**
 * @file cxx_qft/ScalarSingletZ2DMMhInput_npointfunctions_wilsoncoeffs.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.3 .
 */

#ifndef ScalarSingletZ2DMMhInput_CXXQFT_NPOINTFUNCTIONS_H
#define ScalarSingletZ2DMMhInput_CXXQFT_NPOINTFUNCTIONS_H

#include "ScalarSingletZ2DMMhInput_qft.hpp"
...
struct context_with_vertices : context_base {
   ...
   double scale( void ) const {
      return dynamic_cast<ScalarSingletZ2DMMhInput_mass_eigenstates const&>(model).get_scale();
   }
...
public:
   correlation_function_context(
      const ScalarSingletZ2DMMhInput_mass_eigenstates &m,
