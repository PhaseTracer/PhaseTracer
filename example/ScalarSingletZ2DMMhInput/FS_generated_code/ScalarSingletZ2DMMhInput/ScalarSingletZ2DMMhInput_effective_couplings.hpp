...
#ifndef ScalarSingletZ2DMMhInput_EFFECTIVE_COUPLINGS_H
#define ScalarSingletZ2DMMhInput_EFFECTIVE_COUPLINGS_H
...
class ScalarSingletZ2DMMhInput_effective_couplings {
public:
   ScalarSingletZ2DMMhInput_effective_couplings(const ScalarSingletZ2DMMhInput_mass_eigenstates&,
   ...
   void set_model(const ScalarSingletZ2DMMhInput_mass_eigenstates& model_);
