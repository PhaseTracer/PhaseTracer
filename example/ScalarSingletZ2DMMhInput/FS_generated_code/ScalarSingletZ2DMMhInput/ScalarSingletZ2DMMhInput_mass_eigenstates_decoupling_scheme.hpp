...
/**
 * @file ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define ScalarSingletZ2DMMhInput_MASS_EIGENSTATES_DECOUPLING_SCHEME_H

#include "ScalarSingletZ2DMMhInput_info.hpp"
#include "ScalarSingletZ2DMMhInput_physical.hpp"
#include "ScalarSingletZ2DMMhInput_soft_parameters.hpp"
...
#define SUPER(p) ScalarSingletZ2DMMhInput_soft_parameters::p
...
struct ScalarSingletZ2DMMhInput_input_parameters;
class ScalarSingletZ2DMMhInput_mass_eigenstates;

/**
 * @class ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme
   : private ScalarSingletZ2DMMhInput_soft_parameters
   , public ScalarSingletZ2DMMhInput_mass_eigenstates_interface
{
public:
   explicit ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMMhInput_input_parameters& input_ = ScalarSingletZ2DMMhInput_input_parameters());
   explicit ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMMhInput_mass_eigenstates&);
   ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme&) = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme(ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme() = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme& operator=(const ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme&) = default;
   ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme& operator=(ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<ScalarSingletZ2DMMhInput_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const ScalarSingletZ2DMMhInput_mass_eigenstates&);
   ...
   const ScalarSingletZ2DMMhInput_input_parameters& get_input_parameters() const override;
   ScalarSingletZ2DMMhInput_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const ScalarSingletZ2DMMhInput_physical& get_physical() const override;
   ScalarSingletZ2DMMhInput_physical& get_physical() override;
   ...
   void set_physical(const ScalarSingletZ2DMMhInput_physical&) override;
...
private:
   ...
   ScalarSingletZ2DMMhInput_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{ScalarSingletZ2DMMhInput_info::model_name,
                     &ScalarSingletZ2DMMhInput_info::particle_names_getter,
                     &ScalarSingletZ2DMMhInput_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMMhInput_mass_eigenstates_decoupling_scheme&);
