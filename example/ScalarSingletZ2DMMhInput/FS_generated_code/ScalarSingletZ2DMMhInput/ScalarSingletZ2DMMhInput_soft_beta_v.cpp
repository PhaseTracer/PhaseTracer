 ...
 */
double ScalarSingletZ2DMMhInput_soft_parameters::calc_beta_v_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*v*(-5400*traceYdAdjYdYdAdjYd + 1200*traceYdAdjYuYuAdjYd
      ...
      *Sqr(g2) + 8100*traceYuAdjYu*Sqr(g2) - 450*Sqr(g1)*Sqr(g2) + 16000*
      traceYdAdjYd*Sqr(g3) + 16000*traceYuAdjYu*Sqr(g3) + 1200*Sqr(LamH) + 200*
      Sqr(LamSH)));
 ...
 */
double ScalarSingletZ2DMMhInput_soft_parameters::calc_beta_v_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMMhInput_soft_parameters::calc_beta_v_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMMhInput_soft_parameters::calc_beta_v_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
