Get["models/ScalarSingletZ2DMMhInput/ScalarSingletZ2DMMhInput_librarylink.m"];

handle = FSScalarSingletZ2DMMhInputOpenHandle[
    fsSettings -> {
...
spectrum    = FSScalarSingletZ2DMMhInputCalculateSpectrum[handle];
observables = FSScalarSingletZ2DMMhInputCalculateObservables[handle];
FSScalarSingletZ2DMMhInputCloseHandle[handle];
