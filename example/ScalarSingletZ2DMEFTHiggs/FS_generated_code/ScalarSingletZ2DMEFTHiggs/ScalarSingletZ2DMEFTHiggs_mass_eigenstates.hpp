...
/**
 * @file ScalarSingletZ2DMEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_H
#define ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_H
...
class ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface;
/**
 * @class ScalarSingletZ2DMEFTHiggs_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class ScalarSingletZ2DMEFTHiggs_mass_eigenstates
   : public ScalarSingletZ2DMEFTHiggs_soft_parameters
   , public ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit ScalarSingletZ2DMEFTHiggs_mass_eigenstates(const ScalarSingletZ2DMEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEFTHiggs_input_parameters());
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&) = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates(ScalarSingletZ2DMEFTHiggs_mass_eigenstates&&) = default;
   virtual ~ScalarSingletZ2DMEFTHiggs_mass_eigenstates() = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates& operator=(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&) = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates& operator=(ScalarSingletZ2DMEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface>&);
...
private:
   ...
   mutable Problems problems{ScalarSingletZ2DMEFTHiggs_info::model_name,
   ...
   std::shared_ptr<ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&);
