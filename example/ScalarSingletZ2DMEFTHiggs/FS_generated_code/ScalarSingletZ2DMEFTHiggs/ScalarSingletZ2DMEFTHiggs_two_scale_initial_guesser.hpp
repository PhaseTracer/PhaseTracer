...
#ifndef ScalarSingletZ2DMEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define ScalarSingletZ2DMEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "ScalarSingletZ2DMEFTHiggs_initial_guesser.hpp"
...
template <class T>
class ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser;

/**
 * @class ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the ScalarSingletZ2DMEFTHiggs tower
 */

template<>
class ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser(ScalarSingletZ2DMEFTHiggs<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMEFTHiggs_susy_scale_constraint<Two_scale>&,
                               const ScalarSingletZ2DMEFTHiggs_high_scale_constraint<Two_scale>&);
   virtual ~ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   ScalarSingletZ2DMEFTHiggs<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   ScalarSingletZ2DMEFTHiggs_susy_scale_constraint<Two_scale> susy_constraint{};
   ScalarSingletZ2DMEFTHiggs_high_scale_constraint<Two_scale> high_constraint{};
