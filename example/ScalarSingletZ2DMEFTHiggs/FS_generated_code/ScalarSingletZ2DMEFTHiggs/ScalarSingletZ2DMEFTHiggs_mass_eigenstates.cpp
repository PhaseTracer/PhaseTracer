...
/**
 * @file ScalarSingletZ2DMEFTHiggs_mass_eigenstates.cpp
...
#include "ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface.hpp"
#include "config.h"
...
#define CLASSNAME ScalarSingletZ2DMEFTHiggs_mass_eigenstates
...
CLASSNAME::CLASSNAME(const ScalarSingletZ2DMEFTHiggs_input_parameters& input_)
   ...
   , ewsb_solver(new ScalarSingletZ2DMEFTHiggs_ewsb_solver<Two_scale>())
#endif
{
}
...
{
   return std::make_unique<ScalarSingletZ2DMEFTHiggs_mass_eigenstates>(*this);
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving ScalarSingletZ2DMEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
{
   return "ScalarSingletZ2DMEFTHiggs";
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   ScalarSingletZ2DMEFTHiggs_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::VG
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         VG);
}
...
void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMEFTHiggs_info::ss))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::ss
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         ss);
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::Fv
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         Fv);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMEFTHiggs_info::hh))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::hh
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         hh);
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::VP
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         VP);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMEFTHiggs_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(ScalarSingletZ2DMEFTHiggs_info::VZ);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::VZ
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         VZ);
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEFTHiggs_info::Fd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::Fd
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         Fd);
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEFTHiggs_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::Fu
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         Fu);
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         problems.flag_bad_mass(ScalarSingletZ2DMEFTHiggs_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::Fe
         );
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         Fe);
...
{
   if (!force_output && problems.is_running_tachyon(
      ScalarSingletZ2DMEFTHiggs_info::VWp))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.) {
         problems.flag_pole_tachyon(ScalarSingletZ2DMEFTHiggs_info::VWp);
      }
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         VWp);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletZ2DMEFTHiggs_info::
         VWp);
...
double CLASSNAME::calculate_MVZ_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(ScalarSingletZ2DMEFTHiggs_info::VZ);return
         m_pole;
   }
...
double CLASSNAME::calculate_MVWp_DRbar(double m_pole) const
{
   ...
   if (mass_sqr < 0.) {
      problems.flag_pole_tachyon(ScalarSingletZ2DMEFTHiggs_info::VWp);return
         m_pole;
   }
