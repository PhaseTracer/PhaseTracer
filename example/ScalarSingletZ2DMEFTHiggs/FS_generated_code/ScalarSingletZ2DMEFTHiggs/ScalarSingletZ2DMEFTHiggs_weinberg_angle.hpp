...
#ifndef ScalarSingletZ2DMEFTHiggs_WEINBERG_ANGLE_H
#define ScalarSingletZ2DMEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletZ2DMEFTHiggs_weinberg_angle
...
public:
   ...
   ScalarSingletZ2DMEFTHiggs_weinberg_angle(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletZ2DMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
