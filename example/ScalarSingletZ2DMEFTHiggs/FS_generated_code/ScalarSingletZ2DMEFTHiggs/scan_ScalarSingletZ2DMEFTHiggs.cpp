...
{
   std::cout <<
      "Usage: scan_ScalarSingletZ2DMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --LamHInput=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
struct ScalarSingletZ2DMEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
ScalarSingletZ2DMEFTHiggs_scan_result run_parameter_point(int loop_library, const softsusy::QedQcd& qedqcd,
   ScalarSingletZ2DMEFTHiggs_input_parameters& input)
{
   ...
   ScalarSingletZ2DMEFTHiggs_scan_result result;
...
void scan(int solver_type, int loop_library, ScalarSingletZ2DMEFTHiggs_input_parameters& input,
