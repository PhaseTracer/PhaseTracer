 ...
 */
double ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_g2_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_g2_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_g2_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_g2_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_g2_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
