...
/**
 * @file ScalarSingletZ2DMEFTHiggs_b_to_s_gamma.cpp
 *
   ...
   const double& matching_scale)
{
   ...
   wc_json.open ("WC_ScalarSingletZ2DMEFTHiggs.json");
   wc_json << "{\n\"eft\": \"WET\",\n";
...
std::array<std::complex<double>, 4> calculate_b_to_s_gamma(
   const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model, const softsusy::QedQcd& qedqcd)
{
