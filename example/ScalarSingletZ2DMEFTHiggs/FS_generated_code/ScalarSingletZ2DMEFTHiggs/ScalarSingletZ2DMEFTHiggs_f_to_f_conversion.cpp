...
/**
 * @file ScalarSingletZ2DMEFTHiggs_f_to_f_conversion.cpp
 *
...
using namespace ScalarSingletZ2DMEFTHiggs_FFV_form_factors;
...
namespace ScalarSingletZ2DMEFTHiggs_f_to_f_conversion {
...
std::complex<double> vectorCurrent(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model) {
