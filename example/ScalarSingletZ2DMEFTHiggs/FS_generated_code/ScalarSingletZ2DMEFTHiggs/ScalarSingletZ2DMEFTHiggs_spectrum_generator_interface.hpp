...
#ifndef ScalarSingletZ2DMEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
#define ScalarSingletZ2DMEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface {
public:
   virtual ~ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface() = default;

   std::tuple<ScalarSingletZ2DMEFTHiggs<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<ScalarSingletZ2DMEFTHiggs<T>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(ScalarSingletZ2DMEFTHiggs<T>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   const ScalarSingletZ2DMEFTHiggs<T>& get_model() const
   { return model; }
   ScalarSingletZ2DMEFTHiggs<T>& get_model()
   { return model; }
   ScalarSingletZ2DMEFTHiggs<T> get_model_slha() const
   { return ScalarSingletZ2DMEFTHiggs<T>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const ScalarSingletZ2DMEFTHiggs_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "ScalarSingletZ2DMEFTHiggs_spectrum.dat") const;

protected:
   ScalarSingletZ2DMEFTHiggs<T> model;
   ...
   void translate_exception_to_problem(ScalarSingletZ2DMEFTHiggs<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const ScalarSingletZ2DMEFTHiggs_input_parameters&) = 0;
};
 ...
 */
template <class T>
void ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const ScalarSingletZ2DMEFTHiggs_input_parameters& input)
{
 ...
 */
template <class T>
void ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates tmp_model(model);
   try {
   ...
   auto data_getter = [&tmp_model](double scale) {
      ...
      return ScalarSingletZ2DMEFTHiggs_parameter_getter::get_parameters(tmp_model);
   };

   std::vector<std::string> parameter_names(
      std::cbegin(ScalarSingletZ2DMEFTHiggs_info::parameter_names),
      std::cend(ScalarSingletZ2DMEFTHiggs_info::parameter_names));
 ...
 */
template <class T>
void ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   ScalarSingletZ2DMEFTHiggs_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void ScalarSingletZ2DMEFTHiggs_spectrum_generator_interface<T>::translate_exception_to_problem(ScalarSingletZ2DMEFTHiggs<T>& model)
{
   try {
      throw;
