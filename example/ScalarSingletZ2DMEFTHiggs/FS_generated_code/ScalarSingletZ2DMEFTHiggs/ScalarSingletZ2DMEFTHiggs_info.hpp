...
#ifndef ScalarSingletZ2DMEFTHiggs_INFO_H
#define ScalarSingletZ2DMEFTHiggs_INFO_H
...
namespace ScalarSingletZ2DMEFTHiggs_info {
   ...
   class ScalarSingletZ2DMEFTHiggs_particle_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMEFTHiggs_particle_names() = default;
   ...
   class ScalarSingletZ2DMEFTHiggs_parameter_names : public Names {
   public:
      virtual ~ScalarSingletZ2DMEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletZ2DMEFTHiggs_particle_names  particle_names_getter{};
   const ScalarSingletZ2DMEFTHiggs_parameter_names parameter_names_getter{};
