...
#ifndef ScalarSingletZ2DMEFTHiggs_EFFECTIVE_COUPLINGS_H
#define ScalarSingletZ2DMEFTHiggs_EFFECTIVE_COUPLINGS_H
...
class ScalarSingletZ2DMEFTHiggs_effective_couplings {
public:
   ScalarSingletZ2DMEFTHiggs_effective_couplings(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model_);
