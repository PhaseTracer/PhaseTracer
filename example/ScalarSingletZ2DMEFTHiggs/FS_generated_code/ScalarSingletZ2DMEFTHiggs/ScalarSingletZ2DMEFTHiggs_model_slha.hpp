...
/**
 * @file ScalarSingletZ2DMEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */


#ifndef ScalarSingletZ2DMEFTHiggs_SLHA_H
#define ScalarSingletZ2DMEFTHiggs_SLHA_H
...
/**
 * @class ScalarSingletZ2DMEFTHiggs_slha<T>
 * @brief model class wrapper in SLHA convention
 *
 * @tparam Model model class to wrap
 */

class ScalarSingletZ2DMEFTHiggs_slha : public ScalarSingletZ2DMEFTHiggs_mass_eigenstates {
public:
   explicit ScalarSingletZ2DMEFTHiggs_slha(const ScalarSingletZ2DMEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEFTHiggs_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit ScalarSingletZ2DMEFTHiggs_slha(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&, bool do_convert_masses_to_slha = true);
   ScalarSingletZ2DMEFTHiggs_slha(const ScalarSingletZ2DMEFTHiggs_slha&) = default;
   ScalarSingletZ2DMEFTHiggs_slha(ScalarSingletZ2DMEFTHiggs_slha&&) = default;
   virtual ~ScalarSingletZ2DMEFTHiggs_slha() = default;
   ScalarSingletZ2DMEFTHiggs_slha& operator=(const ScalarSingletZ2DMEFTHiggs_slha&) = default;
   ScalarSingletZ2DMEFTHiggs_slha& operator=(ScalarSingletZ2DMEFTHiggs_slha&&) = default;
   ...
   const ScalarSingletZ2DMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   ScalarSingletZ2DMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   ScalarSingletZ2DMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
