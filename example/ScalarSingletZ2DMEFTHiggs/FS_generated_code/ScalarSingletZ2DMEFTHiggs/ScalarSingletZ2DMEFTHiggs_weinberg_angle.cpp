...
#define CLASSNAME ScalarSingletZ2DMEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::ScalarSingletZ2DMEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * ScalarSingletZ2DMEFTHiggs_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * ScalarSingletZ2DMEFTHiggs_info::normalization_g2;
...
double CLASSNAME::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * ScalarSingletZ2DMEFTHiggs_info::normalization_g3 /
