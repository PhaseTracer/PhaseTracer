 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_muS2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_muS2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_muS2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_muS2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_muS2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
