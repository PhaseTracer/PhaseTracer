...
#define CLASSNAME ScalarSingletZ2DMEFTHiggs_standard_model_matching_up<Two_scale>

CLASSNAME::ScalarSingletZ2DMEFTHiggs_standard_model_matching_up(
   standard_model::StandardModel<Two_scale>* low_,
   ScalarSingletZ2DMEFTHiggs<Two_scale>* high_,
...
void CLASSNAME::set_models(Model* low, Model* high)
{
   ...
   model = cast_model<ScalarSingletZ2DMEFTHiggs<Two_scale>*>(high);
}
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      ScalarSingletZ2DMEFTHiggs_standard_model_matching::match_low_to_high_scale_model(*model, *eft, loop_order, higgs_idx);
   else
      ScalarSingletZ2DMEFTHiggs_standard_model_matching::match_low_to_high_scale_model_tree_level(*model, *eft);
}
...
#define CLASSNAME ScalarSingletZ2DMEFTHiggs_standard_model_matching_down<Two_scale>

CLASSNAME::ScalarSingletZ2DMEFTHiggs_standard_model_matching_down(
   standard_model::StandardModel<Two_scale>* low_,
   ScalarSingletZ2DMEFTHiggs<Two_scale>* high_,
   const Scale_getter& scale_getter_,
   int loop_order_,
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      ScalarSingletZ2DMEFTHiggs_standard_model_matching::match_high_to_low_scale_model(*eft, *model, loop_order, higgs_idx);
   else
      ScalarSingletZ2DMEFTHiggs_standard_model_matching::match_high_to_low_scale_model_tree_level(*eft, *model, higgs_idx);
}
