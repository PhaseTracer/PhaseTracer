...
/**
 * @file ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface.hpp
 *
...
#ifndef ScalarSingletZ2DMEFTHiggs_EWSB_SOLVER_INTERFACE_H
#define ScalarSingletZ2DMEFTHiggs_EWSB_SOLVER_INTERFACE_H
...
class ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface {
public:
   virtual ~ScalarSingletZ2DMEFTHiggs_ewsb_solver_interface() {}
   ...
   virtual int solve(ScalarSingletZ2DMEFTHiggs_mass_eigenstates&) = 0;
};
