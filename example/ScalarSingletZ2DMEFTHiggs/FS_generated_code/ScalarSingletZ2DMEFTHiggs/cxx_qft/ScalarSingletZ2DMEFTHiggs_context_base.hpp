...
/**
 * @file cxx_qft/ScalarSingletZ2DMEFTHiggs_context_base.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.3 .
 */

#ifndef ScalarSingletZ2DMEFTHiggs_CXXQFT_CONTEXT_BASE_H
#define ScalarSingletZ2DMEFTHiggs_CXXQFT_CONTEXT_BASE_H
...
namespace ScalarSingletZ2DMEFTHiggs_cxx_diagrams {
   ...
   struct context_base {
      ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface const& model; ///< The model object.
      ...
      context_base(ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface const& m) : model(m) {}
      context_base(ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface const* const m) : model(*m) {}
...
#include "ScalarSingletZ2DMEFTHiggs_vertices.hpp"
