...
/**
 * @file cxx_qft/ScalarSingletZ2DMEFTHiggs_npointfunctions_wilsoncoeffs.hpp
 *
 * This file was generated with FlexibleSUSY 2.5.0 and SARAH 4.14.3 .
 */

#ifndef ScalarSingletZ2DMEFTHiggs_CXXQFT_NPOINTFUNCTIONS_H
#define ScalarSingletZ2DMEFTHiggs_CXXQFT_NPOINTFUNCTIONS_H

#include "ScalarSingletZ2DMEFTHiggs_qft.hpp"
...
struct context_with_vertices : context_base {
   ...
   double scale( void ) const {
      return dynamic_cast<ScalarSingletZ2DMEFTHiggs_mass_eigenstates const&>(model).get_scale();
   }
...
public:
   correlation_function_context(
      const ScalarSingletZ2DMEFTHiggs_mass_eigenstates &m,
