Get["models/ScalarSingletZ2DMEFTHiggs/ScalarSingletZ2DMEFTHiggs_librarylink.m"];

handle = FSScalarSingletZ2DMEFTHiggsOpenHandle[
    fsSettings -> {
...
spectrum    = FSScalarSingletZ2DMEFTHiggsCalculateSpectrum[handle];
observables = FSScalarSingletZ2DMEFTHiggsCalculateObservables[handle];
FSScalarSingletZ2DMEFTHiggsCloseHandle[handle];
