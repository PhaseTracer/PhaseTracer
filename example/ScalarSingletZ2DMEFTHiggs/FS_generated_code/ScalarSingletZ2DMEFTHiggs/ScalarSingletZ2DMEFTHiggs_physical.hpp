...
#ifndef ScalarSingletZ2DMEFTHiggs_PHYSICAL_H
#define ScalarSingletZ2DMEFTHiggs_PHYSICAL_H
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEFTHiggs_physical&);
