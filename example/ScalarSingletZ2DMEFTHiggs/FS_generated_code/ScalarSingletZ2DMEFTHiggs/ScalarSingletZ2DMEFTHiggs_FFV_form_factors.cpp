...
/**
 * @file ScalarSingletZ2DMEFTHiggs_FFV_form_factors.cpp
 *
...
namespace ScalarSingletZ2DMEFTHiggs_FFV_form_factors {
std::valarray<std::complex<double>> calculate_Fe_Fe_VP_form_factors (
   int generationIndex1, int generationIndex2,
   const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model, bool discard_SM_contributions) {
