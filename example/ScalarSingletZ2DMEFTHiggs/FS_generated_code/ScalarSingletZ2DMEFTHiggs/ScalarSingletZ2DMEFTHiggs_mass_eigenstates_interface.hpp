...
/**
 * @file ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface.hpp
 *
...
#ifndef ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
#define ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_INTERFACE_H
...
/**
 * @class ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface
 * @brief Interface definition for model parameters, masses and mixings
 */
class ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface {
public:
   virtual ~ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface() {}

   virtual std::unique_ptr<ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface> clone() const = 0;
   ...
   virtual const ScalarSingletZ2DMEFTHiggs_input_parameters& get_input_parameters() const = 0;
   virtual ScalarSingletZ2DMEFTHiggs_input_parameters& get_input_parameters() = 0;
   virtual Eigen::ArrayXd get_extra_parameters() const = 0;
   virtual const ScalarSingletZ2DMEFTHiggs_physical& get_physical() const = 0;
   virtual ScalarSingletZ2DMEFTHiggs_physical& get_physical() = 0;
   ...
   virtual void set_physical(const ScalarSingletZ2DMEFTHiggs_physical&) = 0;
