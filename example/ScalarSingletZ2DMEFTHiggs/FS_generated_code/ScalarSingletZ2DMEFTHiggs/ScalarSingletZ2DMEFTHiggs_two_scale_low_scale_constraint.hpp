...
#ifndef ScalarSingletZ2DMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define ScalarSingletZ2DMEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "ScalarSingletZ2DMEFTHiggs_low_scale_constraint.hpp"
...
template<>
class ScalarSingletZ2DMEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ScalarSingletZ2DMEFTHiggs_low_scale_constraint() = default;
   ScalarSingletZ2DMEFTHiggs_low_scale_constraint(ScalarSingletZ2DMEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~ScalarSingletZ2DMEFTHiggs_low_scale_constraint() = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "ScalarSingletZ2DMEFTHiggs low-scale constraint"; }
