...
/**
 * @file ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme.hpp
 *
...
#ifndef ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
#define ScalarSingletZ2DMEFTHiggs_MASS_EIGENSTATES_DECOUPLING_SCHEME_H
...
#include "ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface.hpp"
...
#define SUPER(p) ScalarSingletZ2DMEFTHiggs_soft_parameters::p
...
struct ScalarSingletZ2DMEFTHiggs_input_parameters;
class ScalarSingletZ2DMEFTHiggs_mass_eigenstates;

/**
 * @class ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme
 *
 * @brief model class with routines for determing masses and mixings
 * and EWSB in the Stöckinger/Kotlarski decoupling scheme
 */
class ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme
   : private ScalarSingletZ2DMEFTHiggs_soft_parameters
   , public ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface
{
public:
   explicit ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEFTHiggs_input_parameters());
   explicit ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&);
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme(ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   virtual ~ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme() = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme&) = default;
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme& operator=(ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme&&) = default;
   EIGEN_MAKE_ALIGNED_OPERATOR_NEW

   std::unique_ptr<ScalarSingletZ2DMEFTHiggs_mass_eigenstates_interface> clone() const override;
   ...
   void fill_from(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates&);
   ...
   const ScalarSingletZ2DMEFTHiggs_input_parameters& get_input_parameters() const override;
   ScalarSingletZ2DMEFTHiggs_input_parameters& get_input_parameters() override;
   Eigen::ArrayXd get_extra_parameters() const override;
   const ScalarSingletZ2DMEFTHiggs_physical& get_physical() const override;
   ScalarSingletZ2DMEFTHiggs_physical& get_physical() override;
   ...
   void set_physical(const ScalarSingletZ2DMEFTHiggs_physical&) override;
...
private:
   ...
   ScalarSingletZ2DMEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{ScalarSingletZ2DMEFTHiggs_info::model_name,
                     &ScalarSingletZ2DMEFTHiggs_info::particle_names_getter,
                     &ScalarSingletZ2DMEFTHiggs_info::parameter_names_getter}; ///< problems
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEFTHiggs_mass_eigenstates_decoupling_scheme&);
