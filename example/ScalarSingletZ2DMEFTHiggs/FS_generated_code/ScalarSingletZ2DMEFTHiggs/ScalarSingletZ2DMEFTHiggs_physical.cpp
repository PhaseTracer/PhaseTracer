...
void ScalarSingletZ2DMEFTHiggs_physical::clear()
{
   MVG = 0.;
   MHp = 0.;
   Mss = 0.;
 ...
 * to be complex.
 */
void ScalarSingletZ2DMEFTHiggs_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void ScalarSingletZ2DMEFTHiggs_physical::convert_to_slha()
{

}

Eigen::ArrayXd ScalarSingletZ2DMEFTHiggs_physical::get() const
{
...
void ScalarSingletZ2DMEFTHiggs_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd ScalarSingletZ2DMEFTHiggs_physical::get_masses() const
{
...
void ScalarSingletZ2DMEFTHiggs_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   Mss = pars(2);
...
void ScalarSingletZ2DMEFTHiggs_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletZ2DMEFTHiggs_physical& phys_pars)
{
