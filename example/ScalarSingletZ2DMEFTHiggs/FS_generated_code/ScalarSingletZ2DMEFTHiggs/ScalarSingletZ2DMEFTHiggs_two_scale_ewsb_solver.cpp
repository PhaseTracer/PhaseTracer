...
/**
 * @file ScalarSingletZ2DMEFTHiggs_two_scale_ewsb_solver.cpp
 *
...
#define CLASSNAME ScalarSingletZ2DMEFTHiggs_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const ScalarSingletZ2DMEFTHiggs_mass_eigenstates& model) const
{
