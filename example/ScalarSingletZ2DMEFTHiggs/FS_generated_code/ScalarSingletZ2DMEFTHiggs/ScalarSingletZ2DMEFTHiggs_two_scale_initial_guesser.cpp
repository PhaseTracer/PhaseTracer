...
ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser(
   ...
   const ScalarSingletZ2DMEFTHiggs_susy_scale_constraint<Two_scale>& susy_constraint_,
   const ScalarSingletZ2DMEFTHiggs_high_scale_constraint<Two_scale>& high_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("ScalarSingletZ2DMEFTHiggs_initial_guesser: Error: pointer to model"
                       " ScalarSingletZ2DMEFTHiggs<Two_scale> must not be zero");
}
 ...
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_running_SM_masses();
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
...
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_running_SM_masses()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void ScalarSingletZ2DMEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
