 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_v_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_v_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_v_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double ScalarSingletZ2DMEFTHiggs_soft_parameters::calc_beta_v_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
