 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_Yu_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_Yu_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_Yu_3_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_Yu_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletZ2DMEFTHiggs_susy_parameters::calc_beta_Yu_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
