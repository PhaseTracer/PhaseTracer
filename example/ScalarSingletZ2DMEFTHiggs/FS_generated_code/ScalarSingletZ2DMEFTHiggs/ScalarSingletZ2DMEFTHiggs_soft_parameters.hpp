...
#ifndef ScalarSingletZ2DMEFTHiggs_soft_parameters_H
#define ScalarSingletZ2DMEFTHiggs_soft_parameters_H
...
class ScalarSingletZ2DMEFTHiggs_soft_parameters : public ScalarSingletZ2DMEFTHiggs_susy_parameters {
public:
   explicit ScalarSingletZ2DMEFTHiggs_soft_parameters(const ScalarSingletZ2DMEFTHiggs_input_parameters& input_ = ScalarSingletZ2DMEFTHiggs_input_parameters());
   ScalarSingletZ2DMEFTHiggs_soft_parameters(const ScalarSingletZ2DMEFTHiggs_susy_parameters& , double muS2_, double muH2_, double v_);
   ScalarSingletZ2DMEFTHiggs_soft_parameters(const ScalarSingletZ2DMEFTHiggs_soft_parameters&) = default;
   ScalarSingletZ2DMEFTHiggs_soft_parameters(ScalarSingletZ2DMEFTHiggs_soft_parameters&&) = default;
   virtual ~ScalarSingletZ2DMEFTHiggs_soft_parameters() = default;
   ScalarSingletZ2DMEFTHiggs_soft_parameters& operator=(const ScalarSingletZ2DMEFTHiggs_soft_parameters&) = default;
   ScalarSingletZ2DMEFTHiggs_soft_parameters& operator=(ScalarSingletZ2DMEFTHiggs_soft_parameters&&) = default;
   ...
   ScalarSingletZ2DMEFTHiggs_soft_parameters calc_beta() const;
   ScalarSingletZ2DMEFTHiggs_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const ScalarSingletZ2DMEFTHiggs_soft_parameters&);
