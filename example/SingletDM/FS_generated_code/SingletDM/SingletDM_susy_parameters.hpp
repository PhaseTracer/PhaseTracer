...
public:
   ...
   SingletDM_susy_parameters(double scale_, int loops_, int thresholds_, const SingletDM_input_parameters& input_, double g1_, double g2_, double g3_, double LamS_, double LamSH_, double LamH_
