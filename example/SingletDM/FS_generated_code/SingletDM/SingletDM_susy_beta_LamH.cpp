 ...
 */
double SingletDM_susy_parameters::calc_beta_LamH_4_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double SingletDM_susy_parameters::calc_beta_LamH_5_loop(const Susy_traces& susy_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
