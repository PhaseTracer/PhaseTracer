...
// File generated at Tue 18 Aug 2020 22:47:49
 ...
 * parameters.
 *
 * This file was generated at Tue 18 Aug 2020 22:47:49 with FlexibleSUSY
...
CLASSNAME::CLASSNAME(const SingletDM_input_parameters& input_)
...
double CLASSNAME::get_mass_matrix_Hp() const
{
   ...
   const double mass_matrix_Hp = Re(muH + 0.25*(2*LamH + Sqr(g2))*Sqr(v));
...
double CLASSNAME::get_mass_matrix_Ah() const
{
   ...
   const double mass_matrix_Ah = Re(0.25*(4*muH + 2*LamH*Sqr(v) +
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fd, eigenvalue_error > precision *
      Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fu, eigenvalue_error > precision *
      Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fe, eigenvalue_error > precision *
      Abs(MFe(0)));
#else
