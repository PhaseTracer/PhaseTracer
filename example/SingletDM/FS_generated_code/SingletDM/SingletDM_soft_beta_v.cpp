 ...
 */
double SingletDM_soft_parameters::calc_beta_v_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double SingletDM_soft_parameters::calc_beta_v_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
