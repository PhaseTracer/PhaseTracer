...
// File generated at Tue 18 Aug 2020 22:47:59
...
void Model_data::check_spectrum_pointer() const
{
   if (!spectrum) {
      throw SetupError("No spectrum generator set! "
                       "Did you run FSSingletDMCalculateSpectrum[]?");
   }
}
   ...
   WolframLibraryData /* libData */, MLINK link)
{
   ...
   try {
      ...
      put_message(link, "FSSingletDMCalculateObservables", "error", e.what_detailed());
      put_error_output(link);
   }
